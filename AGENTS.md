...
**Note:** This is the golden list for preview-ready components. Components
listed here have reached a maturity level suitable for broader testing and
feedback.
...
- **Package Name**: NPM package identifier (format:
  `@carbon-labs/{component-name}`)
...
1. Parse the markdown tables in the "React Components" and "Web Components"
   sections
...
5. Check the package.json in each component directory for additional metadata
   (including version)
