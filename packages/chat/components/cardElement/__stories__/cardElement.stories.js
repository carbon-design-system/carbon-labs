...
export const Playground = {
  ...
  render: ({
    ...
    ${autoGeneration
      ? html` <c4ai--chat-card type="${type}" content="${content}" /> `
      : html`
          <c4ai--chat-card
            type="${type}"
            .cardElements=${{
...
export const Showcase = {
  ...
  render: () => html`
    ...
    <div style="display:inline-flex; gap:10px;">
      <c4ai--chat-card .cardElements=${urlExamples[0]} type="url">
      </c4ai--chat-card>
      <c4ai--chat-card
        content="https://en.wikipedia.org/wiki/Apollo_11"
        type="url">
      </c4ai--chat-card>
      <c4ai--chat-card .cardElements=${urlExamples[2]} type="url">
      </c4ai--chat-card>
    </div>
    <br />
    <br />
    ...
    <br />
    <div style="display:inline-flex; gap:10px;">
      <c4ai--chat-card .cardElements=${fileExamples[0]} type="file">
      </c4ai--chat-card>
      <c4ai--chat-card .cardElements=${fileExamples[1]} type="file">
      </c4ai--chat-card>
      <c4ai--chat-card
    ...
    <br />
    <div style="display:inline-flex; gap:10px;">
      <c4ai--chat-card .cardElements=${audioExamples[0]} type="audio">
      </c4ai--chat-card>
      <c4ai--chat-card .cardElements=${audioExamples[1]} type="audio">
      </c4ai--chat-card>
      <c4ai--chat-card .cardElements=${audioExamples[2]} type="audio">
      </c4ai--chat-card>
    </div>
  `,
};
