...
**`DatePicker` props:**
- `allowInput` - Allow manual date entry (default: `true`)
- `closeOnSelect` - Close calendar on date selection (default: `true`)
...
to start this at a different date, you can pass in a date string.
...
For detailed state machine documentation, see the [state machine README](https://github.com/carbon-design-system/carbon-labs/tree/main/packages/primitives/src/date-picker/README.md).
