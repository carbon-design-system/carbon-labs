...
export const DatePickerInput = forwardRef<HTMLInputElement, DatePickerInputProps>(
  function DatePickerInput(
    ...
    const isAILabel = candidate && isValidElement(candidate) &&
      (candidate.type as any)?.displayName === 'AILabel';
    
    // Clone AILabel with size='mini' if it's an AILabel
    const normalizedDecorator = isAILabel && isValidElement(candidate)
      ? cloneElement(candidate as React.ReactElement, { size: 'mini' } as any)
      : candidate;
        ...
        <div className={wrapperClasses}>
          <span>
            ...
            {slug ? (
              ...
              <div className={`${prefix}--date-picker-input-inner-wrapper--decorator`}>
                {normalizedDecorator}
              </div>
            ) : null}
