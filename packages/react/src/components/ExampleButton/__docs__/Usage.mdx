import AccordionAnatomy from './images/accordion-anatomy.png';
import AccordionFlush from './images/accordion-flush.png';
import AccordionFlushSpec from './images/accordion-flush-spec.png';
import AccordionAlignmentDo from './images/accordion-alignment-do.png';
import AccordionAlignmentDo2 from './images/accordion-alignment-do-2.png';
import AccordionPlacement2M from './images/accordion-placement-2m.png';
import AccordionPlacement2 from './images/accordion-placement-2.png';
import AccordionPlacement1 from './images/accordion-placement-1.png';
import AccordionState1 from './images/accordion-state-1.png';
import AccordionState2 from './images/accordion-state-2.png';
import AccordionState3 from './images/accordion-state-3.png';
import AccordionClickTarget from './images/accordion-click-target.png';
...
<InlineNotification kind="info">
  ...
  component
  ([source](https://github.com/carbon-design-system/carbon-website/blob/main/src/pages/components/accordion/usage.mdx)).
...
<img alt="accordion anatomy" src={AccordionAnatomy} />
...
<img alt="accordion flush alignment" src={AccordionFlush} />
...
<img alt="accordion flush alignment spec" src={AccordionFlushSpec} />
...
<img
  alt="Do use the default end icon alignment to keep accordion text aligned with other content on the page."
  src={AccordionAlignmentDo}
/>
...
<img
  alt="Do place icons on the start side for tree like functionality."
  src={AccordionAlignmentDo2}
/>
...
<img alt="accordion placement" src={AccordionPlacement2M} />

<img alt="accordion placement" src={AccordionPlacement2} />
...
<img alt="accordion grid placement" src={AccordionPlacement1} />
...
<img alt="accordion states" src={AccordionState1} />
...
<img alt="multiple sections expanded" src={AccordionState2} />
...
<img alt="accordion interactives states" src={AccordionState3} />
...
<img alt="accordion click targets" src={AccordionClickTarget} />
