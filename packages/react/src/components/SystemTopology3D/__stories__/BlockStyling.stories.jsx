...
const meta = {
  title: 'Components/SystemTopology3D/Block Styling',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
These stories demonstrate the visual customization options for blocks in the SystemTopology3D, including color variations, size combinations, and styling patterns.
