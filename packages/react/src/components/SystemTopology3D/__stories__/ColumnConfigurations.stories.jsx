...
const meta = {
  title: 'Components/SystemTopology3D/Column Configurations',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
These stories demonstrate different fixed column layouts for the SystemTopology3D. Use \`lockColumnCount={true}\` with a specific \`primaryColumnCount\` to create fixed-width layouts that don't respond to container size changes.
...
For layouts that adapt to screen size, see the "Responsive Columns" story in the main SystemTopology3D section, which uses \`lockColumnCount={false}\` to automatically switch between 2, 4, 6, and 8 columns based on Carbon Design System breakpoints.
        `,
      },
    },
  },
