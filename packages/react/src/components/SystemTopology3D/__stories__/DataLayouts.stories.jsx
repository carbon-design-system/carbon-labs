...
const meta = {
  title: 'Components/SystemTopology3D/Data Layouts',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
These stories showcase different ways to organize and display data within the SystemTopology3D, demonstrating various block arrangements, overflow handling, and auto-placement behaviors.
