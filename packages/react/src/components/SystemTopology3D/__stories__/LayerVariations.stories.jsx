...
const meta = {
  title: 'Components/SystemTopology3D/Layer Variations',
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
These stories demonstrate the three-layer architecture of SystemTopology3D and how different layer configurations create various visualization styles. Each layer serves a distinct purpose in the data hierarchy.
