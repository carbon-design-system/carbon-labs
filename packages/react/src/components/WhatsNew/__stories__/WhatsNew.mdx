...
The first-time orientation pattern is built using the [`InterstitialScreen`](https://ibm-products.carbondesignsystem.com/?path=/docs/experimental-onboarding-interstitialscreen--docs&globals=theme:white;viewport:basic) component from `@carbon/ibm-products`. 
