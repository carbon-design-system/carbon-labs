...
import * as FirstTimeOrientation from './FirstTimeOrientation.stories';
import {
  Toc,
  TocList,
  TocItem,
...
- [First Time Orientation Pattern](#first-time-orienation)
...
## FirstTimeOrienation
First Time Orienation pattern is build using [InterstitialScreen](https://ibm-products.carbondesignsystem.com/?path=/docs/experimental-onboarding-interstitialscreen--docs&globals=theme:white;viewport:basic) component from @carbon/ibm-products. 

### Stackblitz Examples
[![Example](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/carbon-design-system/carbon-labs/tree/main/examples/react/FirstTimeOrientation)

### Usage

<Canvas>
  <Story of={FirstTimeOrientation.FirstTimeOrientationStory} />
</Canvas>
