...
import * as WhatsNewStories from './WhatsNew.stories';
...
<Canvas of={WhatsNewStories.Default} />
...
yarn add @carbon-labs/react-whats-new
```

### JS (via import)

```javascript
import { WhatsNew } from '@carbon-labs/react-whats-new/es/index';
