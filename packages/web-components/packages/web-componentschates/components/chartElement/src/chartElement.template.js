...
export function chartElementTemplate(customElementClass) {
  ...
  return html`
      ...
      ${chartLoading || errorMessage ? html`
              <div class="${clabsPrefix}--chat-editor-modal-section-chart">
                <div class="${clabsPrefix}--chat-chart-loading-container">
                  ${errorMessage ? html` <div class="${clabsPrefix}--chat-chart-error-grid">
        ...
        <div class="${clabsPrefix}--chat-editor-modal-section-code">
          ...
          ${!editedContent || !_visualizationSpec ? '' : html`
                  ${editOriginalSpecification ? html`
                        <clabs-chat-code
                          editable
    ...
    ${exportedImageURL ? html`
        ...
        ` : html`
          ${_visualizationSpec && !errorMessage && !streaming ? html` <div
                @click="${chartClicked}"
                class="${clabsPrefix}--chat-chart-container"
                id="${clabsPrefix}--chat-chart-embed-vis-${uniqueID}"></div>` : html` <div class="${clabsPrefix}--chat-chart-container">
                <div class="${clabsPrefix}--chat-chart-loading-container">
                  ${errorMessage ? html` <div class="${clabsPrefix}--chat-chart-error-grid">
                          ${unsafeHTML(buildLoader())}
                        </div>
    ...
    slot: 'icon'
        ...
        `}
    ${disableOptions || errorMessage || chartLoading || streaming ? html`` : html` <div
...
//# sourceMappingURL=chartElement.template.js.map
