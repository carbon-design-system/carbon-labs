...
class message extends LitElement {
  ...
  updated(changedProperties) {
    ...
    if (changedProperties.has('bufferMessage')) {
      const messageUpdateEvent = new CustomEvent('on-structure-change', {
        detail: {
          action: 'message: internal change'
        },
        bubbles: true,
        composed: true
      });
  ...
  _getTheme() {
    if (this.parentElement instanceof HTMLElement) {
      ...
      let darkMode = false;
      if (backgroundColor.startsWith('#') && parseInt(backgroundColor.replace('#', ''), 16) < 0xffffff / 2) {
        darkMode = true;
      }
  ...
  _checkBlockEnd() {
    ...
    if (stopIndex !== null && stopIndex !== -1) {
      if (this.currentType === 'array' || this.currentType === 'carousel' || this.currentType === 'tags' || this.currentType === 'chart' || this.currentType === 'json') {
        stopIndex++;
      }
  ...
  _checkAmbiguousBlock() {
    ...
    if (this.currentType === 'array') {
      ...
      const items = this.bufferMessage.replace('[', '').replace(new RegExp(',\\s*$'), '').split(',');
      if (items.length > 1) {
  ...
  _beginStreaming() {
    ...
    this.streamingInterval = setTimeout(() => {
        ...
        if (blockSignal.type !== '') {
            ...
            if (blockSignal.type === 'text') {
              ...
              if (splitter.length > 0) {
                for (let i = 0; i < splitter.length - 1; i++) {
                  ...
                  this._messageElements = [...this._messageElements, {
                    content: subLine,
                    type: 'text'
                  }];
          ...
          if (blockSignal.status === 'ended') {
            ...
            if (blockSignal.type === 'text') {
              ...
              this._messageElements = [...this._messageElements, {
                content: blockSignal.content,
                type: blockSignal.type
              }];
            }
          }
        } else {
      ...
      this.streamingSpeed = this.baseStreamingSpeed + Math.random() * Math.random() * Math.random() * this.baseStreamingSpeed * 5;
  ...
  _signalEndOfStreaming() {
    const endOfStreamingEvent = new CustomEvent('on-message-streaming-done', {
      detail: {
        action: 'message component reported end of streaming'
      },
      bubbles: true,
      composed: true
    });
        ...
        if (blockSignal.type !== '') {
          if (blockSignal.status === 'started') {
            ...
            if (blockSignal.preBlockText.length > 0) {
              if (blockSignal.preBlockText.trim() !== '') {
                this._messageElements = [...this._messageElements, {
                  content: blockSignal.preBlockText,
                  type: 'text'
                }];
              }
            }
    ...
    for (const item of splitter) {
      try {
        ...
        if (objectType === 'multi-url') {
          splitParts.concat(testJSON.map(url => ({
            content: url,
            type: 'url'
          })));
        } else {
...
__decorate([state()], message.prototype, "_messageElements", void 0);
__decorate([property({
  type: Boolean,
  attribute: 'user-submitted'
...
__decorate([state()], message.prototype, "_editedMessage", void 0);
__decorate([property({
  type: String,
  attribute: 'parent-theme'
})], message.prototype, "_parentTheme", void 0);
__decorate([property({
  type: String,
  attribute: 'origin'
})], message.prototype, "origin", void 0);
__decorate([state()], message.prototype, "showFeedBackForm", void 0);
__decorate([property({
  type: String,
...
__decorate([state()], message.prototype, "_editing", void 0);
__decorate([property({
  type: String,
  attribute: 'display-color',
  reflect: true
})], message.prototype, "displayColor", void 0);
__decorate([state()], message.prototype, "watsonIconLight", void 0);
__decorate([state()], message.prototype, "watsonIconDark", void 0);
__decorate([property({
  type: Boolean,
  attribute: 'stream-content'
})], message.prototype, "_streamContent", void 0);
__decorate([property({
  type: Boolean,
  attribute: 'enable-complex-feedback'
})], message.prototype, "enableComplexFeedback", void 0);
__decorate([state()], message.prototype, "_forceStreamEnd", void 0);
__decorate([state()], message.prototype, "temporaryMessage", void 0);
__decorate([state()], message.prototype, "streamingIndex", void 0);
__decorate([state()], message.prototype, "tokens", void 0);
__decorate([state()], message.prototype, "currentlyStreaming", void 0);
__decorate([state()], message.prototype, "bufferMessage", void 0);
__decorate([state()], message.prototype, "currentType", void 0);
__decorate([state()], message.prototype, "streamingInterval", void 0);
__decorate([state()], message.prototype, "streamingSpeed", void 0);
__decorate([state()], message.prototype, "baseStreamingSpeed", void 0);
__decorate([state()], message.prototype, "feedbackFormTarget", void 0);
__decorate([state()], message.prototype, "positiveFeedbackSelected", void 0);
__decorate([state()], message.prototype, "negativeFeedbackSelected", void 0);
__decorate([property({
  type: Object,
  attribute: 'feedbackFormDefinitions'
})], message.prototype, "feedbackFormDefinitions", void 0);
__decorate([state()], message.prototype, "_feedbackFormOrientation", void 0);
__decorate([state()], message.prototype, "_feedbackFormValues", void 0);
__decorate([state()], message.prototype, "popupTargetElement", void 0);
__decorate([state()], message.prototype, "uniqueFeedbackId", void 0);
__decorate([property({
  type: Object,
  attribute: 'customLabels'
})], message.prototype, "customLabels", void 0);
__decorate([state()], message.prototype, "_readerContent", void 0);
__decorate([state()], message.prototype, "previousMessageWidth", void 0);
