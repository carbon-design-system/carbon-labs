...
export function tableElementTemplate(customElementClass) {
  ...
  return html`<div
    ...
    ${invalid === true ? html` <div class="${clabsPrefix}--chat-table-error">
          <p>Error displaying table</p>
        </div>` : html` <div class="${clabsPrefix}--chat-table-container">
          ${!renderAsDataTable ? html` <table>
                <thead>
                  <tr>
                ...
                <tbody>
                  ${tableObject.rows.map(row => html` <tr>
...
//# sourceMappingURL=tableElement.template.js.map
