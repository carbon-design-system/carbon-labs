...
export default {
  title: 'Generative A.I. Components/Charts V2',
  component: 'clabs-chat-chart-v2',
};
...
const controls = {
  ...
  debugMode: {
    ...
    default: true,
    description: 'debug-mode - Enable explicit error details in chart viewer',
  },
  carbonify: {
    control: { type: 'boolean' },
    default: true,
  ...
  enableLegendFiltering: {
    ...
    default: false,
    description:
      'enable-legend-filtering - Allow users to filter data using legend',
  },
  enableMultiSelection: {
    control: { type: 'boolean' },
    default: false,
    description:
      'enable-multi-selections - Allow users to select multi items in groups with brush',
  },
  enableSingleSelection: {
    control: { type: 'boolean' },
    default: false,
    description:
      'enable-single-selections - Allow users to select a single item',
  },
};
...
export const DefaultTest = {
   ...
   */
  render: () => html` <clabs-chat-chart-v2
  ...
  render: () => html`
    <div style="display:flex;gap:16px;">
      <clabs-chat-chart-v2
        ...
        container-height="246px"
        container-height="328px">
      </clabs-chat-chart-v2>
      <clabs-chat-chart-v2
        thumbnail
...
export const Showcase = {
  ...
  render: ({ chartTheme }) => html`<h3>Single layer Charts:</h3>
    ...
    <clabs-chat-chart-v2
      ...
      @clabs-chart-vega-selection="${(event) => console.log(event)}"
      container-width="400">
    </clabs-chat-chart-v2>
    <br />
    ...
    <clabs-chat-chart-v2
      ...
      @clabs-chart-vega-selection="${(event) => console.log(event)}"
      theme="${chartTheme}"
      content="${'{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://vega.github.io/editor/data/weather.csv"},"transform":[{"calculate":"year(datum.date)","as":"year"},{"fold":["temp_max","temp_min"],"as":["type","temperature"]},{"calculate":"[\'Winter\',\'Winter\',\'Spring\',\'Spring\',\'Spring\',\'Summer\',\'Summer\',\'Summer\',\'Fall\',\'Fall\',\'Fall\',\'Winter\'][month(datum.date)]","as":"season"},{"filter":"datum.year >= 2012 && datum.year <= 2015"}],"facet":{"row":{"field":"year","type":"ordinal"}},"spec":{"vconcat":[{"hconcat":[{"mark":"rect","width":600,"height":200,"encoding":{"y":{"field":"date","timeUnit":"date","type":"ordinal","title":"Day","axis":{"labelAngle":0,"format":"%e"}},"x":{"field":"date","timeUnit":"month","type":"ordinal","title":"Month"},"color":{"field":"temp_max","aggregate":"max","type":"quantitative"}}},{"mark":"point","encoding":{"x":{"field":"wind","type":"quantitative"},"y":{"field":"precipitation","type":"quantitative"},"color":{"field":"temp_max","aggregate":"max","type":"quantitative","legend":{"title":null}}}}]},{"repeat":{"column":["precipitation","wind","temperature"]},"spec":{"vconcat":[{"layer":[{"mark":"boxplot","encoding":{"x":{"timeUnit":"month","field":"date","type":"temporal","title":"Month"},"y":{"field":{"repeat":"column"},"aggregate":"sum","type":"quantitative"},"y2":{"field":"temp_min"},"color":{"field":"season","type":"nominal"}}},{"mark":{"type":"point","color":"black","strokeWidth":2},"encoding":{"x":{"timeUnit":"month","field":"date","type":"temporal"},"y":{"aggregate":"mean","field":{"repeat":"column"},"type":"quantitative"}}}]},{"layer":[{"mark":"bar","height":60,"encoding":{"x":{"timeUnit":"month","field":"date","type":"temporal"},"y":{"aggregate":"mean","field":{"repeat":"column"},"type":"quantitative"},"color":{"field":"season","type":"nominal"}}},{"mark":{"type":"line","color":"#F4F4F4","strokeWidth":2},"encoding":{"x":{"timeUnit":"month","field":"date","type":"temporal"},"y":{"aggregate":"mean","field":{"repeat":"column"},"type":"quantitative"}}}]}]}}],"resolve":{"scale":{"y":"independent"}}}}'}">
    </clabs-chat-chart-v2>
    <br />
    <h4>Box Plot</h4>
    <br />
    ...
    <clabs-chat-chart-v2
      theme="${chartTheme}"
      content="${'{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","description":"Plot showing a 30 day rolling average with raw values in the background.","data":{"url":"https://vega.github.io/vega-lite/data/seattle-weather.csv"},"transform":[{"window":[{"field":"temp_max","op":"mean","as":"rolling_mean"}],"frame":[-15,15]}],"encoding":{"x":{"field":"date","type":"temporal","title":"Date"},"y":{"type":"quantitative","axis":{"title":"Max Temperature and Rolling Mean"}}},"layer":[{"mark":{"type":"point","color":"#1192e8","opacity":0.7},"encoding":{"y":{"field":"temp_max","title":"Max Temperature"}}},{"mark":{"type":"line","color":"#ff832b","size":3},"encoding":{"y":{"field":"rolling_mean","title":"Rolling Mean of Max Temperature"}}}]}'}"
      container-height="350px">
    </clabs-chat-chart-v2>
    <br />
    <br />
...
export const ChartSkeleton = {
   ...
   * @returns {TemplateResult<1>}
   */
  render: () => html` <clabs-chat-chart-v2> </clabs-chat-chart-v2>`,
};
