...
The **Carbon Labs Text** component aims to provide a simple text element that
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Make LLM responses more formal (should be avoided on user messages)
      </td>
    </tr>
    <tr>
      <td>align-right</td>
    ...
    <tr>
      ...
      <td>boolean</td>
      <td>
        Removes the chevron/underline and highlights annotations with a default
        color
      </td>
