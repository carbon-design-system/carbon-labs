...
const argTypes = {
  ...
  kind: {
    ...
    mapping: { 'Error': 'error', 'No data': 'noData', 'No tags': 'noTags', 'Not found': 'notFound', 'Notifications': 'notifications', 'Unauthorized': 'unauthorized' },
  },
  illustrationTheme: {
    control: 'radio',
    description:
