...
const localhost = 'http://localhost:6007/iframe.html?globals=&args=&id=components-global-header-subcomponents-webmethods-hybrid-integration-header--basic&viewMode=story';
const localhostWithChat = 'http://localhost:6007/iframe.html?globals=&args=&id=components-global-header-subcomponents-webmethods-hybrid-integration-header--with-ai-chat&viewMode=story'
const localhostWithSearch = 'http://localhost:6007/iframe.html?globals=&args=&id=components-global-header-subcomponents-webmethods-hybrid-integration-header--search-callback&viewMode=story'
const localhostWithTrial = 'http://localhost:6007/iframe.html?globals=&args=&id=components-global-header-subcomponents-webmethods-hybrid-integration-header--basic-with-trial&viewMode=story'
const localhostWithCustomFooter = 'http://localhost:6007/iframe.html?globals=&args=&id=components-global-header-subcomponents-webmethods-hybrid-integration-header--custom-footer&viewMode=story'
...
Scenario('Environment switcher menu renders and opens menu when clicked', async ({ I }) => {
  I.amOnPage(localhost)
...
Scenario('Capability menu renders and opens menu when clicked', async ({ I }) => {
  I.amOnPage(localhost)
  I.waitForElement('clabs-global-header-apaas', 30)
...
Scenario('Profile action renders and opens menu when clicked', async ({ I }) => {
  I.amOnPage(localhost)
  I.waitForElement('clabs-global-header-apaas', 30)
