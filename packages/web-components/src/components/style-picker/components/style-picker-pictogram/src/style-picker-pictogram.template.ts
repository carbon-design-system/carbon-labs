...
export const blockClass = `${clabsPrefix}--style-picker-pictogram`;
 ...
 */
export const stylePickerPictogramTemplate = (
  customElementClass
): TemplateResult<1> => {
  const { items, heading, size, selectedItem, moduleIndex, item } =
    customElementClass;
