  ...
  return html`
    <c4ai-table>
      ...
      <c4ai-table-header-description slot="description"
        >With batch actions. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
        accumsan mauris sed congue egestas. Integer varius mauris vel arcu pulvinar bibendum non sit
        amet ligula. Nullam ut nisi eu tellus aliquet vestibulum vel sit amet
        odio.</c4ai-table-header-description
      >
      ...
      <c4ai-table-toolbar slot="toolbar">
        ...
        <c4ai-table-toolbar-content ?has-batch-actions="true">
          ...
          <c4ai-button>Add new</c4ai-button>
...
export default {
  title: 'Forked Components/DataTable/Batch Actions',
  parameters: {
