...
export const Default = () => {
  return html`
    <c4ai-table expandable>
      ...
      <c4ai-table-header-description slot="description">With expansion</c4ai-table-header-description>
...
export const BatchExpansion = () => {
  return html`
    <c4ai-table expandable batch-expansion>
      <c4ai-table-header-title slot="title">DataTable</c4ai-table-header-title>
      <c4ai-table-header-description slot="description">With expansion</c4ai-table-header-description>
    ...
    return html`
      ...
      >
        ...
        <c4ai-table-header-description slot="description"
          >With expansion</c4ai-table-header-description
        >
...
export default {
  title: 'Forked Components/DataTable/Expansion',
  parameters: {
