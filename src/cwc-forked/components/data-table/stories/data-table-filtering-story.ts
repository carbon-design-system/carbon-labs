...
export const Default = () => {
  return html`
    <c4ai-table>
      ...
      <c4ai-table-header-description slot="description">With filtering</c4ai-table-header-description>
    ...
    return html`
      ...
      >
        ...
        <c4ai-table-header-description slot="description"
          >With filtering</c4ai-table-header-description
        >
...
export default {
  title: 'Forked Components/DataTable/Filtering',
  parameters: {
