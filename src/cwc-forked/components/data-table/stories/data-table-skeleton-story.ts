...
const headers = ['Name', 'Protocol', 'Port', 'Rule', 'Attached groups', 'Status'];

export const Default = () => {
  return html` <c4ai-table-skeleton .headers=${headers}> </c4ai-table-skeleton>`;
};
...
export default {
  title: 'Forked Components/DataTable/Skeleton',
  parameters: {
