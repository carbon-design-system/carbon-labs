...
export const ExpandableWithLayer = () => {
  return html`
    <sb-template-layers>
      <c4ai-search size="lg" expandable placeholder="Layer two"></c4ai-search>
    </sb-template-layers>
  `;
};
...
export const WithLayer = () => {
  return html`
    <sb-template-layers>
      <c4ai-search size="lg" placeholder="Find your items"></c4ai-search>
    </sb-template-layers>
  `;
};
  ...
  parameters: {
    knobs: {
      [`${prefix}-search`]: () => ({
        ...
        placeholder: textNullable('Placeholder text (placeholder)', 'Placeholder text'),
...
export default {
  title: 'Forked Components/Search',
  parameters: {
