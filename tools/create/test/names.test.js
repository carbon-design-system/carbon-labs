...
describe('toPascalCase', () => {
  ...
  it('handles multi-word kebab', () =>
    expect(toPascalCase('data-table-toolbar')).toBe('DataTableToolbar'));
  it('handles mixed separators', () =>
    expect(toPascalCase('data_table-toolbar')).toBe('DataTableToolbar'));
});

describe('toParamCase', () => {
  it('converts PascalCase', () =>
    expect(toParamCase('MyButton')).toBe('my-button'));
  it('converts camelCase', () =>
    expect(toParamCase('myButton')).toBe('my-button'));
  it('preserves kebab-case', () =>
    expect(toParamCase('my-button')).toBe('my-button'));
  it('converts snake_case', () =>
    expect(toParamCase('my_button')).toBe('my-button'));
...
describe('validateComponentName', () => {
  ...
  it('rejects empty string', () =>
    expect(() => validateComponentName('')).toThrow());
...
describe('applyNameCasing', () => {
  it('returns PascalCase for react', () =>
