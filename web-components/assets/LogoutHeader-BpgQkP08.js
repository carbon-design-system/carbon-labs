import{a as M,i,x as n,d as c}from"./iframe-Sj3RSdEd.js";import{n as l,t as d}from"./property-DdzyH9_e.js";import{s as h}from"./settings-BQP9c3yA.js";import{A as p}from"./constant-NpqH8VlU.js";const L=M`/**
 * @license
 *
 ...
 */.automation-global-header__logout-header{padding-block:1rem}`;var m=Object.defineProperty,u=Object.getOwnPropertyDescriptor,Z=(a,e,o,r)=>{for(var H=r>1?void 0:r?u(e,o):e,t=a.length-1,V;t>=0;t--)(V=a[t])&&(H=(r?V(e,o,H):V(H))||H);return r&&H&&m(e,o,H),H};const{stablePrefix:C}=h,g=`${p}__logout-header`,f=n`
  <svg
    width="45"
    height="18"
    viewBox="0 0 45 18"
