import{a as M,i,x as n,g as c}from"./iframe-C8ES9dvz.js";import{n as l,t as d}from"./property-CwdThEqz.js";import{s as h}from"./settings-BQP9c3yA.js";import{A as p}from"./constant-NpqH8VlU.js";const L=M`/**
 * @license
 *
 ...
 */.automation-global-header__logout-header{padding-block:1rem}`;var m=Object.defineProperty,u=Object.getOwnPropertyDescriptor,Z=(a,e,o,r)=>{for(var H=r>1?void 0:r?u(e,o):e,t=a.length-1,V;t>=0;t--)(V=a[t])&&(H=(r?V(e,o,H):V(H))||H);return r&&H&&m(e,o,H),H};const{stablePrefix:g}=h,C=`${p}__logout-header`,f=n`
  <svg
    width="45"
    height="18"
    viewBox="0 0 45 18"
...
`;let s=class extends i{constructor(){super(...arguments),this.brandCompany=""}render(){return n` <cds-custom-header class="${C}">
      <cds-custom-header-name>
        ${this.brandCompany==="IBM"?f:this.brandCompany}
      </cds-custom-header-name>
    </cds-custom-header>`}};s.styles=M`
    ${c([L])}
  `;Z([l({type:String})],s.prototype,"brandCompany",2);s=Z([d(`${g}-global-header-logout-banner`)],s);export{s as L};
