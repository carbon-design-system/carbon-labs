import{i as g,d as u,x as t,j as h}from"./iframe-CzarNakE.js";import{n as C,t as L}from"./property-Bj9LMGCf.js";import{s as v}from"./settings-BQP9c3yA.js";import{A as f}from"./constant-CsTv1dpG.js";import"./preload-helper-C1FmrZbK.js";const y=g`/**
 * @license
 *
 ...
 */.automation-global-header__logout-header{padding-block:1rem}`;var _=Object.defineProperty,w=Object.getOwnPropertyDescriptor,Z=(c,o,H,a)=>{for(var e=a>1?void 0:a?w(o,H):o,l=c.length-1,d;l>=0;l--)(d=c[l])&&(e=(a?d(o,H,e):d(e))||e);return a&&e&&_(o,H,e),e};const{stablePrefix:B}=v,x=`${f}__logout-header`,S=t`
  <svg
    width="45"
    height="18"
    viewBox="0 0 45 18"
...
`;let r=class extends u{constructor(){super(...arguments),this.brandCompany=""}render(){return t` <cds-custom-header class="${x}">
      <cds-custom-header-name>
        ${this.brandCompany==="IBM"?S:this.brandCompany}
      </cds-custom-header-name>
    </cds-custom-header>`}};r.styles=g`
    ${h([y])}
  `;Z([C({type:String})],r.prototype,"brandCompany",2);r=Z([L(`${B}-global-header-logout-banner`)],r);/**
 * @license
 *
 * Copyright IBM Corp. 2025
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const $={title:"Components/Global Header/Subcomponents/Logout Header",tags:["autodocs"],render:()=>new r,args:{}},n={render:()=>t`
    <div role="main">
  ...
  `};var V,i,m;n.parameters={...n.parameters,docs:{...(V=n.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: () => html\`
    <div role="main">
      <clabs-global-header-logout-banner
        brandCompany="Company name"></clabs-global-header-logout-banner>
  ...
  \`
}`,...(m=(i=n.parameters)==null?void 0:i.docs)==null?void 0:m.source}}};var p,b,M;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => html\`
    <div role="main">
      <clabs-global-header-logout-banner
        brandCompany="IBM"></clabs-global-header-logout-banner>
  ...
  \`
}`,...(M=(b=s.parameters)==null?void 0:b.docs)==null?void 0:M.source}}};const j=["Basic","Corporate"];export{n as Basic,s as Corporate,j as __namedExportsOrder,$ as default};
