import{i as u,d as g,x as t,g as C}from"./iframe-Djr0lfyz.js";import{n as L,t as v}from"./property-DDzsV19b.js";import{A as y}from"./constant-CsTv1dpG.js";import"./preload-helper-C1FmrZbK.js";const b=u`/**
 * @license
 *
 ...
 */.automation-global-header__logout-header{padding-block:1rem}`;var _=Object.defineProperty,f=Object.getOwnPropertyDescriptor,h=(p,r,n,o)=>{for(var e=o>1?void 0:o?f(r,n):r,d=p.length-1,V;d>=0;d--)(V=p[d])&&(e=(o?V(r,n,e):V(e))||e);return o&&e&&_(r,n,e),e};const w=`${y}__logout-header`,B=t`
  <svg
    width="45"
    height="18"
    viewBox="0 0 45 18"
...
`;let a=class extends g{constructor(){super(...arguments),this.brandCompany=""}render(){return t` <cds-custom-header class="${w}">
      <cds-custom-header-name>
        ${this.brandCompany==="IBM"?B:this.brandCompany}
      </cds-custom-header-name>
    </cds-custom-header>`}};a.styles=u`
    ${C([b])}
  `;h([L({type:String})],a.prototype,"brandCompany",2);a=h([v("apaas-logout-header")],a);/**
 * @license
 *
 * Copyright IBM Corp. 2025
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const E={title:"Components/Global Header/Subcomponents/Logout Header",tags:["autodocs"],render:()=>new a,args:{}},s={render:()=>t`
    <div role="main">
  ...
  \`
}`,...(m=(c=s.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};var l,M,Z;H.parameters={...H.parameters,docs:{...(l=H.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => html\`
    <div role="main">
      <apaas-logout-header brandCompany="IBM"></apaas-logout-header>
    </div>
  \`
}`,...(Z=(M=H.parameters)==null?void 0:M.docs)==null?void 0:Z.source}}};const I=["Basic","Corporate"];export{s as Basic,H as Corporate,I as __namedExportsOrder,E as default};
