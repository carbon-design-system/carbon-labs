import{n as e}from"./chunk-gsjJvkCQ.js";import{a as t}from"./lit-Cfdn9GWx.js";import"./chartElement-DvL2KJRR.js";var n=JSON.parse(`[{"title":"","prompt":"Make a pair-plot of all columns with scatter plots, use bar distributions when columns match","result":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://raw.githubusercontent.com/vega/vega-datasets/main/data/cars.json"},"repeat":{"row":["Miles_per_Gallon","Cylinders","Displacement","Horsepower","Weight_in_lbs","Acceleration"],"column":["Miles_per_Gallon","Cylinders","Displacement","Horsepower","Weight_in_lbs","Acceleration"]},"spec":{"layer":[{"mark":{"type":"point","tooltip":true},"encoding":{"x":{"field":{"repeat":"column"},"type":"quantitative","scale":{"zero":false}},"y":{"field":{"repeat":"row"},"type":"quantitative","scale":{"zero":false}}}},{"transform":[{"filter":"datum.repeat_row === datum.repeat_column"}],"mark":"bar","encoding":{"x":{"field":{"repeat":"column"},"bin":true,"type":"quantitative"},"y":{"aggregate":"count","type":"quantitative"}}}]}}},{"title":"","prompt":"Make a pair-plot of all columns with scatter plots, use bar distributions when columns match","result":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://vega.github.io/editor/data/weather.csv"},"repeat":{"row":["Row1","Row2"],"column":["Col1","Col2","Col3"]},"spec":{"vconcat":[{"title":"layered Chart","layer":[{"mark":"line","encoding":{"x":{"field":"date","type":"temporal"},"y":{"field":"temp_max","type":"quantitative"},"color":{"field":"weather","type":"nominal"}}},{"mark":"point","encoding":{"x":{"field":"date","type":"temporal"},"y":{"field":"temp_min","type":"quantitative"},"color":{"field":"weather","type":"nominal"}}}]},{"title":"lower chart","height":50,"mark":"bar","encoding":{"x":{"field":"date","type":"temporal"},"y":{"field":"precipitation","type":"quantitative"},"color":{"field":"weather","type":"nominal"}}}]}}},{"title":"","prompt":"Create two violin plots with sepal width","result":{"$schema":"https://vega.github.io/schema/vega/v5.json","description":"A violin plot example showing distributions for iris sepal width.","width":300,"height":400,"padding":5,"config":{"axisBand":{"bandPosition":1,"tickExtra":true,"tickOffset":0}},"signals":[{"name":"plotWidth","update":"(width - 50)/3"},{"name":"height","update":"height * 1"}],"data":[{"name":"iris","url":"https://raw.githubusercontent.com/mwaskom/seaborn-data/refs/heads/master/iris.csv","format":{"type":"csv"},"transform":[{"type":"filter","expr":"datum.species != null && datum.sepal_width != null"}]},{"name":"density","source":"iris","transform":[{"type":"kde","field":"sepal_width","groupby":["species"],"extent":[1,5]}]},{"name":"stats","source":"iris","transform":[{"type":"aggregate","groupby":["species"],"fields":["sepal_width","sepal_width","sepal_width"],"ops":["q1","median","q3"],"as":["q1","median","q3"]}]}],"scales":[{"name":"layout","type":"band","range":"width","domain":{"data":"iris","field":"species"}},{"name":"yscale","type":"linear","range":"height","round":true,"domain":{"data":"iris","field":"sepal_width"},"domainMin":1,"domainMax":5,"zero":false,"nice":true,"reverse":false},{"name":"hscale","type":"linear","range":[0,{"signal":"plotWidth"}],"domain":{"data":"density","field":"density"}},{"name":"color","type":"ordinal","domain":{"data":"iris","field":"species"},"range":"category"}],"axes":[{"orient":"bottom","scale":"layout","zindex":1,"title":"Species"},{"orient":"left","scale":"yscale","zindex":1,"title":"Sepal Width"}],"marks":[{"type":"group","from":{"facet":{"data":"density","name":"violin","groupby":"species"}},"encode":{"enter":{"xc":{"scale":"layout","field":"species","band":0.5},"width":{"signal":"plotWidth"},"height":{"signal":"height"}}},"data":[{"name":"summary","source":"stats","transform":[{"type":"filter","expr":"datum.species === parent.species"}]}],"marks":[{"type":"area","from":{"data":"violin"},"encode":{"enter":{"orient":{"value":"horizontal"},"fill":{"scale":"color","field":{"parent":"species"}}},"update":{"y":{"field":"value","scale":"yscale"},"xc":{"signal":"plotWidth / 2"},"width":{"scale":"hscale","field":"density"}}}},{"type":"rect","from":{"data":"summary"},"encode":{"enter":{"fill":{"value":"black"},"width":{"value":2}},"update":{"y":{"scale":"yscale","field":"q1"},"y2":{"scale":"yscale","field":"q3"},"xc":{"signal":"plotWidth / 2"}}}},{"type":"rect","from":{"data":"summary"},"encode":{"enter":{"fill":{"value":"black"},"height":{"value":2},"width":{"value":8}},"update":{"y":{"scale":"yscale","field":"median"},"xc":{"signal":"plotWidth / 2"}}}}]}]}},{"title":"Airline passengers example","prompt":"Show a repeating line chart with 6,8,24 and 36 month averages","result":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://raw.githubusercontent.com/mwaskom/seaborn-data/master/flights.csv"},"hconcat":[{"vconcat":[{"mark":"line","encoding":{"x":{"field":"date","type":"temporal","title":"Date"},"y":{"field":"passengers","type":"quantitative","title":"Passengers"}},"transform":[{"window":[{"op":"mean","field":"passengers","as":"6-month-moving-average"}],"frame":[-6,0]}],"layer":[{"mark":"line"},{"mark":{"type":"line","color":"red","strokeDash":[5,5]},"encoding":{"y":{"field":"6-month-moving-average"}}}],"title":"6-month Moving Average"},{"mark":"line","encoding":{"x":{"field":"date","type":"temporal","title":"Date"},"y":{"field":"passengers","type":"quantitative","title":"Passengers"}},"transform":[{"window":[{"op":"mean","field":"passengers","as":"8-month-moving-average"}],"frame":[-8,0]}],"layer":[{"mark":"line"},{"mark":{"type":"line","color":"blue","strokeDash":[5,5]},"encoding":{"y":{"field":"8-month-moving-average"}}}],"title":"8-month Moving Average"}]},{"vconcat":[{"mark":"line","encoding":{"x":{"field":"date","type":"temporal","title":"Date"},"y":{"field":"passengers","type":"quantitative","title":"Passengers"}},"transform":[{"window":[{"op":"mean","field":"passengers","as":"24-month-moving-average"}],"frame":[-24,0]}],"layer":[{"mark":"line"},{"mark":{"type":"line","color":"green","strokeDash":[5,5]},"encoding":{"y":{"field":"24-month-moving-average"}}}],"title":"24-month Moving Average"},{"mark":"line","encoding":{"x":{"field":"date","type":"temporal","title":"Date"},"y":{"field":"passengers","type":"quantitative","title":"Passengers"}},"transform":[{"window":[{"op":"mean","field":"passengers","as":"36-month-moving-average"}],"frame":[-36,0]}],"layer":[{"mark":"line"},{"mark":{"type":"line","color":"orange","strokeDash":[5,5]},"encoding":{"y":{"field":"36-month-moving-average"}}}],"title":"36-month Moving Average"}]}]}},{"title":"","prompt":"Create two violin plots with sepal width","result":{"$schema":"https://vega.github.io/schema/vega/v5.json","description":"A violin plot example showing distributions for iris sepal width.","width":300,"height":400,"padding":5,"config":{"axisBand":{"bandPosition":1,"tickExtra":true,"tickOffset":0}},"signals":[{"name":"plotWidth","update":"(width - 50)/3"},{"name":"height","update":"height * 1"}],"data":[{"name":"iris","url":"https://raw.githubusercontent.com/mwaskom/seaborn-data/refs/heads/master/iris.csv","format":{"type":"csv"},"transform":[{"type":"filter","expr":"datum.species != null && datum.sepal_length != null"}]},{"name":"density","source":"iris","transform":[{"type":"kde","field":"sepal_length","groupby":["species"],"extent":[3,9]}]},{"name":"stats","source":"iris","transform":[{"type":"aggregate","groupby":["species"],"fields":["sepal_length","sepal_length","sepal_length"],"ops":["q1","median","q3"],"as":["q1","median","q3"]}]}],"scales":[{"name":"layout","type":"band","range":"width","domain":{"data":"iris","field":"species"}},{"name":"yscale","type":"linear","range":"height","round":true,"domain":{"data":"iris","field":"sepal_length"},"domainMin":3,"domainMax":9,"zero":false,"nice":true,"reverse":false},{"name":"hscale","type":"linear","range":[0,{"signal":"plotWidth"}],"domain":{"data":"density","field":"density"}},{"name":"color","type":"ordinal","domain":{"data":"iris","field":"species"},"range":"category"}],"axes":[{"orient":"bottom","scale":"layout","zindex":1,"title":"Species"},{"orient":"left","scale":"yscale","zindex":1,"title":"Sepal Width"}],"marks":[{"type":"group","from":{"facet":{"data":"density","name":"violin","groupby":"species"}},"encode":{"enter":{"xc":{"scale":"layout","field":"species","band":0.5},"width":{"signal":"plotWidth"},"height":{"signal":"height"}}},"data":[{"name":"summary","source":"stats","transform":[{"type":"filter","expr":"datum.species === parent.species"}]}],"marks":[{"type":"area","from":{"data":"violin"},"encode":{"enter":{"orient":{"value":"horizontal"},"fill":{"scale":"color","field":{"parent":"species"}}},"update":{"y":{"field":"value","scale":"yscale"},"xc":{"signal":"plotWidth / 2"},"width":{"scale":"hscale","field":"density"}}}},{"type":"rect","from":{"data":"summary"},"encode":{"enter":{"fill":{"value":"black"},"width":{"value":2}},"update":{"y":{"scale":"yscale","field":"q1"},"y2":{"scale":"yscale","field":"q3"},"xc":{"signal":"plotWidth / 2"}}}},{"type":"rect","from":{"data":"summary"},"encode":{"enter":{"fill":{"value":"black"},"height":{"value":2},"width":{"value":8}},"update":{"y":{"scale":"yscale","field":"median"},"xc":{"signal":"plotWidth / 2"}}}}]}]}},{"title":"","prompt":"","result":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://vega.github.io/editor/data/weather.csv"},"title":"Daily Max Temperatures (C) in Cleveland, OH","config":{"view":{"strokeWidth":0,"step":13},"axis":{"domain":false}},"mark":"rect","encoding":{"x":{"field":"date","timeUnit":"date","type":"ordinal","title":"Day","axis":{"labelAngle":0,"format":"%e"}},"y":{"field":"date","timeUnit":"month","type":"ordinal","title":"Month"},"color":{"field":"temp_max","aggregate":"max","type":"quantitative","legend":{"title":null}}}}}]`),r=JSON.parse(`[{"name":"weather example","spec":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://vega.github.io/editor/data/weather.csv"},"concat":[{"title":"Average Precipitation by Month","mark":"line","encoding":{"x":{"timeUnit":"month","field":"date","type":"temporal","axis":{"format":"%b","title":"Month"}},"y":{"aggregate":"mean","field":"precipitation","type":"quantitative","title":"Average Precipitation"}}},{"title":"2012 Daily Max Temperature Heatmap","transform":[{"filter":"timeFormat(datum.date, '%Y') === '2012'"},{"timeUnit":"month","field":"date","as":"month"},{"timeUnit":"date","field":"date","as":"day"}],"mark":"rect","encoding":{"x":{"field":"day","type":"ordinal","title":"Day","axis":{"values":[1,5,10,15,20,25,31]}},"y":{"field":"month","type":"ordinal","title":"Month","axis":{"labelExpr":"['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][datum.value - 1]"}},"color":{"field":"temp_max","type":"quantitative","title":"Max Temperature","scale":{"scheme":"inferno"}}}},{"title":"Temperature Distribution by Month","transform":[{"timeUnit":"month","field":"date","as":"month"},{"fold":["temp_max","temp_min"],"as":["variable","temperature"]}],"layer":[{"mark":"boxplot","encoding":{"x":{"field":"month","type":"ordinal","title":"Month","axis":{"labelExpr":"['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][datum.value - 1]"}},"y":{"field":"temperature","type":"quantitative","title":"Temperature"},"color":{"field":"variable","type":"nominal","title":"Temperature Type"}}},{"transform":[{"aggregate":[{"op":"mean","field":"temperature","as":"mean_temperature"}],"groupby":["month","variable"]}],"mark":{"type":"point","filled":true,"size":50,"color":"black"},"encoding":{"x":{"field":"month","type":"ordinal","axis":{"labelExpr":"['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][datum.value - 1]"}},"y":{"field":"mean_temperature","type":"quantitative"},"color":{"field":"variable","type":"nominal"}}}]},{"title":"Weather Streamgraph Over Time (Weighted by Temp Max)","transform":[{"timeUnit":"yearmonth","field":"date","as":"yearmonth"}],"mark":"area","encoding":{"x":{"field":"yearmonth","type":"temporal","axis":{"domain":false,"format":"%b %y","tickSize":0,"labelOverlap":"parity"},"title":"Year-Month"},"y":{"aggregate":"sum","field":"temp_max","stack":"center","title":"Sum of Temp Max"},"color":{"field":"weather","type":"nominal","scale":{"scheme":"category20b"},"title":"Weather"}}}],"columns":2}},{"name":"concat","spec":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","description":"Two horizonally concatenated charts that show a histogram of precipitation in Seattle and the relationship between min and max temperature.","data":{"url":"https://vega.github.io/editor/data/weather.csv"},"transform":[{"filter":"datum.location === 'Seattle'"}],"columns":2,"concat":[{"mark":"bar","encoding":{"x":{"timeUnit":"month","field":"date","type":"ordinal"},"y":{"aggregate":"mean","field":"precipitation"}}},{"mark":"bar","encoding":{"x":{"timeUnit":"month","field":"date","type":"ordinal"},"y":{"aggregate":"median","field":"precipitation"}}},{"mark":"point","encoding":{"x":{"field":"temp_min","bin":true},"y":{"field":"temp_max","bin":true},"size":{"aggregate":"count"}}}]}},{"name":"trellis","spec":{"name":"trellis_barley","$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://vega.github.io/vega-lite/data/barley.json"},"mark":"point","height":{"step":12},"encoding":{"facet":{"field":"site","type":"ordinal","columns":2,"sort":{"op":"median","field":"yield"}},"x":{"aggregate":"median","field":"yield","type":"quantitative","scale":{"zero":false}},"y":{"field":"variety","type":"ordinal","sort":"-x"},"color":{"field":"year","type":"nominal"}}}},{"name":"trellis_barley","spec":{"name":"trellis_barley","$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://vega.github.io/vega-lite/data/barley.json"},"mark":"point","height":{"step":12},"encoding":{"facet":{"field":"site","type":"ordinal","columns":2,"sort":{"op":"median","field":"yield"}},"x":{"aggregate":"median","field":"yield","type":"quantitative","scale":{"zero":false}},"y":{"field":"variety","type":"ordinal","sort":"-x"},"color":{"field":"year","type":"nominal"}}}},{"name":"hconcat","spec":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","description":"Horizontally concatenated charts that show different types of discretizing scales.","data":{"values":[{"a":"A","b":28},{"a":"B","b":55},{"a":"C","b":43},{"a":"D","b":91},{"a":"E","b":81},{"a":"F","b":53},{"a":"G","b":19},{"a":"H","b":87},{"a":"I","b":52}]},"hconcat":[{"mark":"circle","encoding":{"y":{"field":"b","type":"nominal","sort":null,"axis":{"ticks":false,"domain":false,"title":null}},"size":{"field":"b","type":"quantitative","scale":{"type":"quantize"}},"color":{"field":"b","type":"quantitative","scale":{"type":"quantize","zero":true},"legend":{"title":"Quantize"}}}},{"mark":"circle","encoding":{"y":{"field":"b","type":"nominal","sort":null,"axis":{"ticks":false,"domain":false,"title":null}},"size":{"field":"b","type":"quantitative","scale":{"type":"quantile","range":[80,160,240,320,400]}},"color":{"field":"b","type":"quantitative","scale":{"type":"quantile","scheme":"magma"},"legend":{"format":"d","title":"Quantile"}}}},{"mark":"circle","encoding":{"y":{"field":"b","type":"nominal","sort":null,"axis":{"ticks":false,"domain":false,"title":null}},"size":{"field":"b","type":"quantitative","scale":{"type":"threshold","domain":[30,70],"range":[80,200,320]}},"color":{"field":"b","type":"quantitative","scale":{"type":"threshold","domain":[30,70],"scheme":"viridis"},"legend":{"title":"Threshold"}}}}],"resolve":{"scale":{"color":"independent","size":"independent"}}}},{"name":"vconcat","spec":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","description":"Horizontally concatenated charts that show different types of discretizing scales.","data":{"values":[{"a":"A","b":28},{"a":"B","b":55},{"a":"C","b":43},{"a":"D","b":91},{"a":"E","b":81},{"a":"F","b":53},{"a":"G","b":19},{"a":"H","b":87},{"a":"I","b":52}]},"vconcat":[{"mark":"circle","encoding":{"x":{"field":"b","type":"nominal","sort":null,"axis":{"ticks":false,"domain":false,"title":null}},"size":{"field":"b","type":"quantitative","scale":{"type":"quantize"}},"color":{"field":"b","type":"quantitative","scale":{"type":"quantize","zero":true},"legend":{"title":"Quantize"}}}},{"mark":"circle","encoding":{"x":{"field":"b","type":"nominal","sort":null,"axis":{"ticks":false,"domain":false,"title":null}},"size":{"field":"b","type":"quantitative","scale":{"type":"quantile","range":[80,160,240,320,400]}},"color":{"field":"b","type":"quantitative","scale":{"type":"quantile","scheme":"magma"},"legend":{"format":"d","title":"Quantile"}}}},{"mark":"circle","encoding":{"x":{"field":"b","type":"nominal","sort":null,"axis":{"ticks":false,"domain":false,"title":null}},"size":{"field":"b","type":"quantitative","scale":{"type":"threshold","domain":[30,70],"range":[80,200,320]}},"color":{"field":"b","type":"quantitative","scale":{"type":"threshold","domain":[30,70],"scheme":"viridis"},"legend":{"title":"Threshold"}}}}],"resolve":{"scale":{"color":"independent","size":"independent"}}}},{"name":"concat","spec":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","description":"A population pyramid for the US in 2000.","data":{"url":"https://vega.github.io/editor/data/population.json"},"transform":[{"filter":"datum.year == 2000"},{"calculate":"datum.sex == 2 ? 'Female' : 'Male'","as":"gender"}],"spacing":0,"hconcat":[{"transform":[{"filter":{"field":"gender","equal":"Female"}}],"title":"Female","mark":"bar","encoding":{"y":{"field":"age","axis":null,"sort":"descending"},"x":{"aggregate":"sum","field":"people","title":"population","axis":{"format":"s"},"sort":"descending"},"color":{"field":"gender","scale":{"range":["#675193","#ca8861"]},"legend":null}}},{"width":20,"view":{"stroke":null},"mark":{"type":"text","align":"center"},"encoding":{"y":{"field":"age","type":"ordinal","axis":null,"sort":"descending"},"text":{"field":"age","type":"quantitative"}}},{"transform":[{"filter":{"field":"gender","equal":"Male"}}],"title":"Male","mark":"bar","encoding":{"y":{"field":"age","title":null,"axis":null,"sort":"descending"},"x":{"aggregate":"sum","field":"people","title":"population","axis":{"format":"s"}},"color":{"field":"gender","legend":null}}}],"config":{"view":{"stroke":null},"axis":{"grid":false}}}},{"name":"repeat","spec":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","repeat":{"row":["Horsepower","Acceleration","Miles_per_Gallon"],"column":["Miles_per_Gallon","Acceleration","Horsepower"]},"spec":{"data":{"url":"https://vega.github.io/vega-lite/examples/data/cars.json"},"mark":"point","params":[{"name":"brush","select":{"type":"interval","resolve":"union","on":"[pointerdown[event.shiftKey], window:pointerup] > window:pointermove!","translate":"[pointerdown[event.shiftKey], window:pointerup] > window:pointermove!","zoom":"wheel![event.shiftKey]"}},{"name":"grid","select":{"type":"interval","resolve":"global","translate":"[pointerdown[!event.shiftKey], window:pointerup] > window:pointermove!","zoom":"wheel![!event.shiftKey]"},"bind":"scales"}],"encoding":{"x":{"field":{"repeat":"column"},"type":"quantitative"},"y":{"field":{"repeat":"row"},"type":"quantitative","axis":{"minExtent":30}},"color":{"condition":{"param":"brush","field":"Origin","type":"nominal"},"value":"grey"}}}}},{"name":"repeat and layer","spec":{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","data":{"url":"https://vega.github.io/vega-lite/examples/data/movies.json"},"repeat":{"layer":["US Gross","Worldwide Gross"]},"spec":{"mark":"line","encoding":{"x":{"bin":true,"field":"IMDB Rating","type":"quantitative"},"y":{"aggregate":"mean","field":{"repeat":"layer"},"type":"quantitative","title":"Mean of US and Worldwide Gross"},"color":{"datum":{"repeat":"layer"},"type":"nominal"}}}}}]`),i=e({ChartError:()=>v,ChartSkeleton:()=>_,ComplexExamples:()=>d,Default:()=>c,FacetingTest:()=>f,MultiLayerCharts:()=>m,Playground:()=>g,RepeatingLayerCharts:()=>p,Showcase:()=>u,Thumbnails:()=>l,__namedExportsOrder:()=>y,default:()=>a}),a={title:`Components/AI Components/Chart`,component:`clabs-chat-chart`},o={content:{},debugMode:!1,carbonify:!0,containerHeight:`300px`,containerWidth:`100%`,chartTheme:`g100`,renderMethod:`canvas`,loading:!0,disableOptions:!1,disableEditor:!1,disableCodeInspector:!1,disableExport:!1,disableFullscreen:!1,enableMultiSelection:!1,enableSingleSelection:!1,enableZooming:!1,enableLegendFiltering:!1,enableTooltip:!1},s={content:{control:{type:`object`},default:``,description:`content - Specification string including data.values`},debugMode:{control:{type:`boolean`},default:!0,description:`debug-mode - Enable explicit error details in chart viewer`},carbonify:{control:{type:`boolean`},default:!0,description:`carbonify - Enable post-hoc carbon charts styling`},containerHeight:{control:{type:`text`},default:`246px`,description:`container-height - Must be valid CSS`},containerWidth:{control:{type:`text`},default:`100%`,description:`container-width - Must be valid CSS`},chartTheme:{control:{type:`select`},default:`white`,description:`theme - Chart color theme`,options:[`white`,`g100`]},renderMethod:{control:{type:`select`},default:`canvas`,description:`canvas - Chart rendering mode`,options:[`canvas`,`svg`]},loading:{control:{type:`boolean`},default:!0,description:`loading - enabled by default until spec is displayed`},disableOptions:{control:{type:`boolean`},default:!1,description:`disable-options - Hide button in options`},disableEditor:{control:{type:`boolean`},default:!1,description:`disable-editor - Hide button in options`},disableFullscreen:{control:{type:`boolean`},default:!1,description:`disable-fullscreen - Hide button in options`},disableCodeInspector:{control:{type:`boolean`},default:!1,description:`disable-code-inspector - Hide button in options`},disableExport:{control:{type:`boolean`},default:!1,description:`disable-export - Hide button in options`},enableZooming:{control:{type:`boolean`},default:!1,description:`enable-zooming - Enable zooming in charts`},enableTooltip:{control:{type:`boolean`},default:!1,description:`enable-tooltip - Enable tooltip in charts`},enableLegendFiltering:{control:{type:`boolean`},default:!1,description:`enable-legend-filtering - Allow users to filter data using legend`},enableMultiSelection:{control:{type:`boolean`},default:!1,description:`enable-multi-selections - Allow users to select multi items in groups with brush`},enableSingleSelection:{control:{type:`boolean`},default:!1,description:`enable-single-selections - Allow users to select a single item`}},c={render:()=>t` <clabs-chat-chart
  ...
  `},u={argTypes:s,args:o,parameters:{controls:{expanded:!0},layout:`fullscreen`},render:({chartTheme:e})=>t`<h3>Single layer Charts:</h3>
      <br />
  ...
  `},f={render:()=>t`
    ...
    <br />
  `},p={render:()=>t` <h4>Interactive multi-scatter plot</h4>
      <br />
      <clabs-chat-chart
        content="${`{"$schema":"https://vega.github.io/schema/vega-lite/v5.json","repeat":{"row":["Horsepower","Acceleration","Miles_per_Gallon"],"column":["Miles_per_Gallon","Acceleration","Horsepower"]},"spec":{"data":{"url":"https://vega.github.io/vega-lite/examples/data/cars.json"},"mark":"point","params":[{"name":"brush","select":{"type":"interval","resolve":"union","on":"[pointerdown[event.shiftKey], window:pointerup] > window:pointermove!","translate":"[pointerdown[event.shiftKey], window:pointerup] > window:pointermove!","zoom":"wheel![event.shiftKey]"}},{"name":"grid","select":{"type":"interval","resolve":"global","translate":"[pointerdown[!event.shiftKey], window:pointerup] > window:pointermove!","zoom":"wheel![!event.shiftKey]"},"bind":"scales"}],"encoding":{"x":{"field":{"repeat":"column"},"type":"quantitative"},"y":{"field":{"repeat":"row"},"type":"quantitative","axis":{"minExtent":30}},"color":{"condition":{"param":"brush","field":"Origin","type":"nominal"},"value":"grey"}}}}`}"
        container-height="450px"
  ...
  `},_={render:()=>t` <clabs-chat-chart> </clabs-chat-chart>`},v={render:()=>t` <clabs-chat-chart
