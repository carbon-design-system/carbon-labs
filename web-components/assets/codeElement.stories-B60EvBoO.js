import{R as e}from"./iframe-C5ungBK8.js";import"./button-ByUMeqOx.js";import"./codeElement-BQzX1oT7.js";var t={title:`Components/AI Components/Code`,component:`clabs-chat-code`},n={render:()=>e` <clabs-chat-code
...
def Prime(number,itr):
	...
	if Prime(number,itr-1) == False:
		return False
	return True`}">
    </clabs-chat-code>`},r={content:`from math import sqrt
#prime function to check given number prime or not:
def Prime(number,itr):
	#base condition
	if itr == 1:
	...
	if Prime(number,itr-1) == False:
		return False
	return True`,editable:!1,disableLineTicks:!1,disableEditButton:!0,disableCopyButton:!0},i={"code-copypaste-button":`Copier le code`,"code-copypaste-success":`Copié!`,"code-estimated-warning":`(estimé)`,"code-editing-validation":`Appliquer`,"code-editing-cancelled":`Annuler`,"code-line-descriptor":`lignes`},a={cmd:`node -v`,bash:`$ npm install --save carbon-components`,"console multi":`user@Macbook-Air server % npm run build
...
export const Default = () => {
    ...
    <clabs-chat-code content="${a[`C++`]}"> </clabs-chat-code>
    <br />
    <h4>C++ with no height set and collapsable</h4>
    <clabs-chat-code enable-block-collapse content="${a[`C++`]}">
    </clabs-chat-code>
    <br />
    <h4>C++ with max-height 200px</h4>
    <clabs-chat-code max-height="200px" content="${a[`C++`]}">
    </clabs-chat-code>
    <br />
    ...
    <clabs-chat-code
      disable-line-ticks
      disable-coloring
      content="${a[`python code`]}">
    </clabs-chat-code>
    <br />
    <h4>SQL example without ticks</h4>
    <clabs-chat-code
      content="${a[`SQL example`]}"
      ?disable-line-ticks="${!0}">
    </clabs-chat-code>
    <br />
    <br />
    ...
    <br />
    <clabs-chat-code content="${a.html}"> </clabs-chat-code>
    <br />
    <h4>HTML example with tab-size=6</h4>
    <br />
    <clabs-chat-code tab-size="6" content="${a.html}">
    </clabs-chat-code>
    <br />
    <br />
    <h3>Localization</h3>
  ...
  `},s={render:()=>e` ${Object.keys(a).map(t=>e`
        <clabs-chat-code
          max-height="300px"
          enable-language-display
          enable-estimated-language
...
def Prime(number,itr):
  ...
  \`
}`,...u.parameters?.docs?.source}}};var d=[`Default`,`OptionShowcase`,`ColorTesting`,`Comparison`,`Editing`,`Playground`];export{s as ColorTesting,c as Comparison,n as Default,l as Editing,o as OptionShowcase,u as Playground,d as __namedExportsOrder,t as default};