import{L as e,q as t}from"./iframe-B-_BHJcW.js";import"./button-tgzSw2tf.js";import"./codeElement-CZLv03PN.js";var n=t({ColorTesting:()=>l,Comparison:()=>u,Default:()=>i,Editing:()=>d,OptionShowcase:()=>c,Playground:()=>f,__namedExportsOrder:()=>p,default:()=>r}),r={title:`Components/AI Components/Code`,component:`clabs-chat-code`},i={render:()=>e` <clabs-chat-code
...
def Prime(number,itr):
	...
	if Prime(number,itr-1) == False:
		return False
	return True`}">
    </clabs-chat-code>`},a={content:`from math import sqrt
#prime function to check given number prime or not:
def Prime(number,itr):
	#base condition
	if itr == 1:
	...
	if Prime(number,itr-1) == False:
		return False
	return True`,editable:!1,disableLineTicks:!1,disableEditButton:!0,disableCopyButton:!0},o={"code-copypaste-button":`Copier le code`,"code-copypaste-success":`Copié!`,"code-estimated-warning":`(estimé)`,"code-editing-validation":`Appliquer`,"code-editing-cancelled":`Annuler`,"code-line-descriptor":`lignes`},s={cmd:`node -v`,bash:`$ npm install --save carbon-components`,"console multi":`user@Macbook-Air server % npm run build
...
export const Default = () => {
    ...
    <clabs-chat-code content="${s[`C++`]}"> </clabs-chat-code>
    <br />
    <h4>C++ with no height set and collapsable</h4>
    <clabs-chat-code enable-block-collapse content="${s[`C++`]}">
    </clabs-chat-code>
    <br />
    <h4>C++ with max-height 200px</h4>
    <clabs-chat-code max-height="200px" content="${s[`C++`]}">
    </clabs-chat-code>
    <br />
    ...
    <clabs-chat-code
      disable-line-ticks
      disable-coloring
      content="${s[`python code`]}">
    </clabs-chat-code>
    <br />
    <h4>SQL example without ticks</h4>
    <clabs-chat-code
      content="${s[`SQL example`]}"
      ?disable-line-ticks="${!0}">
    </clabs-chat-code>
    <br />
    <br />
    ...
    <br />
    <clabs-chat-code content="${s.html}"> </clabs-chat-code>
    <br />
    <h4>HTML example with tab-size=6</h4>
    <br />
    <clabs-chat-code tab-size="6" content="${s.html}">
    </clabs-chat-code>
    <br />
    <br />
    <h3>Localization</h3>
  ...
  `},l={render:()=>e` ${Object.keys(s).map(t=>e`
        <clabs-chat-code
          max-height="300px"
          enable-language-display
          enable-estimated-language
          display-line-count
          displayed-language=${t}
          content="${s[t]}">
        </clabs-chat-code>
        <br />
      `)}`},u={render:()=>e`
...
def Prime(number,itr):
  ...
  `},d={render:()=>e` <h4>
    ...
    "mark": "point"
      ...
      <clabs-chat-code
        max-height="492px"
        ?editable="${!0}"
        content="${s.Dockerfile}">
      </clabs-chat-code>`},f={argTypes:{CodeExample:{control:{type:`select`},description:`Code examples`,options:Object.keys(s),table:{category:`Code examples`}},DisableLineTicks:{control:{type:`boolean`},description:`Show/Hide line count ticks when displaying code`,table:{category:`Disable line ticks`}},Editable:{control:{type:`boolean`},description:`Allow editing of content`,table:{category:`Editable`}},DisableEditButton:{control:{type:`boolean`},description:`Show/Hide edit controls`,table:{category:`Disable edit button`}},DisableCopyButton:{control:{type:`boolean`},description:`Show/Hide copy button`,table:{category:`Disable copy button`}}},args:a,parameters:{controls:{expanded:!0},layout:`fullscreen`,viewport:{defaultViewport:`storybook-default`}},render:({CodeExample:t,DisableLineTicks:n,Editable:r,DisableEditButton:i,DisableCopyButton:a})=>e`
    <clabs-chat-code
      content="${s[t]}"
      ?editable="${r}"
      ?disable-line-ticks="${n}"
      ?disable-copy-button="${a}"
      ?disable-edit-button="${i}">
    </clabs-chat-code>
  ...
  \`
}`,...f.parameters?.docs?.source}}};var p=[`Default`,`OptionShowcase`,`ColorTesting`,`Comparison`,`Editing`,`Playground`];export{l as ColorTesting,u as Comparison,i as Default,d as Editing,c as OptionShowcase,f as Playground,p as __namedExportsOrder,r as default,n as t};