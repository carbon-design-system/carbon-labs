var x={elem:"svg",attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16",fill:"currentColor",width:16,height:16},content:[{elem:"path",attrs:{d:"M8,1C4.1,1,1,4.1,1,8s3.1,7,7,7s7-3.1,7-7S11.9,1,8,1z M10.7,11.5L4.5,5.3l0.8-0.8l6.2,6.2L10.7,11.5z"}},{elem:"path",attrs:{fill:"none",d:"M10.7,11.5L4.5,5.3l0.8-0.8l6.2,6.2L10.7,11.5z","data-icon-path":"inner-path",opacity:"0"}}],name:"error--filled",size:16};/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function m({context:r,subscribe:t}){return(s,o)=>{typeof o=="object"?o.addInitializer(function(){new u(this,{context:r,callback:i=>{s.set.call(this,i)},subscribe:t})}):s.constructor.addInitializer(i=>{new u(i,{context:r,callback:c=>{i[o]=c},subscribe:t})})}}export{x as _,m as c,k as e,f as n};
