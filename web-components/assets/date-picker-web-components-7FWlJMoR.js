import{j as e,M as l,C as d,A as s}from"./blocks-Cz5KUHue.js";import{useMDXComponents as c}from"./index-B5qUHUi6.js";import{D as a,S as r,a as o,R as h,b as p,W as x}from"./date-picker-web-components.stories-Byor9rLG.js";import"./preload-helper-C1FmrZbK.js";import"./iframe-8JZxzsaW.js";import"./index-COWg0daL.js";import"./directive-CJw_OlP2.js";import"./unsafe-html-D9GJgQTt.js";import"./index-C3nV9oXV.js";import"./16-B9g2nIv4.js";import"./property-BQ92Vv3_.js";import"./class-map-CChK4zxq.js";import"./state-DKtrWmzo.js";import"./query-BApjzB0v.js";import"./if-defined-BZ2ImSdV.js";import"./16-DeKHrdu0.js";import"./16-CQhU3uUy.js";import"./16-z4EPQvwm.js";import"./layer-DpDla3iz.js";import"./carbon-element-DvT6Hso_.js";import"./ai-label-action-button-DCq9_85q.js";import"./toggletip-BSJWQpLA.js";import"./host-listener-C4Ji6v3a.js";import"./focus-CH_-ZGzI.js";import"./deep-shadow-contains-DvAal_Dv.js";import"./floating-ui.dom-DgLPPlcg.js";import"./icon-loader-BRCoB0SD.js";import"./16-hRAwM-Pz.js";import"./button-nItUT0LW.js";function t(i){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...c(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{of:a}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#simple-date-picker",children:"Simple date picker"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#single-date-picker",children:"Single date picker"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#range-date-picker",children:"Range date picker"})}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#cds-date-picker",children:e.jsx(n.code,{children:"cds-date-picker"})})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#cds-date-picker-input",children:e.jsx(n.code,{children:"cds-date-picker-input"})})}),`
...
location or need. The `,e.jsx(n.code,{children:"cds-date-picker"}),` component expects one or more
`,e.jsx(n.code,{children:"cds-date-picker-input"})," elements as children."]}),`
`,e.jsx(d,{of:r}),`
...
`,e.jsx(d,{of:o}),`
`,e.jsx(n.h3,{id:"single-date-picker",children:"Single date picker"}),`
`,e.jsx(n.p,{children:`Use the single date picker when you want to pair a text input with a calendar
...
`,e.jsxs(n.p,{children:[`Use the range date picker when users need to choose a start and end date
together. The first input should use `,e.jsx(n.code,{children:'kind="from"'}),` and the second should use
`,e.jsx(n.code,{children:'kind="to"'}),"."]}),`
`,e.jsx(d,{of:h}),`
`,e.jsx(n.h3,{id:"skeleton-state",children:"Skeleton state"}),`
`,e.jsxs(n.p,{children:["You can use the ",e.jsx(n.code,{children:"cds-date-picker-input-skeleton"}),` component to render a
...
`,e.jsx(n.p,{children:"The input supports Carbon AI label content as slotted child content."}),`
`,e.jsx(d,{of:x}),`
`,e.jsx(n.h2,{id:"component-api",children:"Component API"}),`
`,e.jsx(n.h3,{id:"api-compatibility",children:"API Compatibility"}),`
`,e.jsx(n.p,{children:`This implementation maintains backward compatibility with the existing Carbon
...
`,e.jsx(n.p,{children:e.jsxs(n.strong,{children:[e.jsx(n.code,{children:"cds-date-picker"})," attributes/properties:"]})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"name"})," - Form field name for form submission"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"readonly"})," - Make the date picker read-only"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"value"})," - Selected date value"]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsxs(n.strong,{children:[e.jsx(n.code,{children:"cds-date-picker-input"})," attributes/properties:"]})}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.p,{children:"Pass a value string to the input to initialize the selected date."}),`
...
`,e.jsxs(n.p,{children:[`For more detail on the shared state logic, see the primitives package in
`,e.jsx(n.a,{href:"https://github.com/carbon-design-system/carbon-labs/tree/main/packages/primitives/src/date-picker",rel:"nofollow",children:"GitHub"}),"."]}),`
...
`,e.jsx(n.a,{href:"https://github.com/carbon-design-system/carbon/edit/main/packages/web-components/src/components/date-picker/date-picker.mdx",rel:"nofollow",children:"GitHub"}),"."]})]})}function O(i={}){const{wrapper:n}={...c(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{O as default};
