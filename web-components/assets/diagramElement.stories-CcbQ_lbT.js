import{R as e}from"./iframe-ymcA4d0K.js";import"./diagramElement-DvkWa6pO.js";var t={title:`Components/Research/Diagram`},n=[{title:`Diagram test`,width:126,height:126,thumbnail:!0,definition:`%% Basic example
      graph TD;
      A[start] --> B[End];
...
`}],r={render:()=>e` ${n.map(t=>e`
  ...
  render: () => html\` \${examples.map(example => html\`
      ...
      \`)}\`
}`,...r.parameters?.docs?.source}}};var i=[`Showcase`];export{r as Showcase,i as __namedExportsOrder,t as default};