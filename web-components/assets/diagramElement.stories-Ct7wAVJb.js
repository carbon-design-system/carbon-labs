import{n as e}from"./chunk-gsjJvkCQ.js";import{a as t}from"./lit-Cfdn9GWx.js";import"./diagramElement-BUgb9THr.js";var n=e({Showcase:()=>a,__namedExportsOrder:()=>o,default:()=>r}),r={title:`Components/Research/Diagram`},i=[{title:`Diagram test`,width:126,height:126,thumbnail:!0,definition:`%% Basic example
      graph TD;
      A[start] --> B[End];
...
`}],a={render:()=>t` ${i.map(e=>t`
  ...
  render: () => html\` \${examples.map(example => html\`
      ...
      \`)}\`
}`,...a.parameters?.docs?.source}}};var o=[`Showcase`];export{a as Showcase,o as __namedExportsOrder,r as default,n as t};