import{c as e,m as t,n,s as r}from"./blocks-t0QcCqrS.js";import{n as i}from"./lib-RDQGeJtf.js";import{n as a}from"./storybook-cdn-rxpev161.js";import o from"./empty-state.stories-Bry49LI0.js";var s=t(),c={name:`@carbon-labs/wc-empty-state`,version:`0.23.0`,publishConfig:{access:`public`,provenance:!0},description:`Carbon Labs - empty-state component`,license:`Apache-2.0`,repository:{type:`git`,url:`https://github.com/carbon-design-system/carbon-labs`,directory:`packages/empty-state`},main:`./src/index.js`,module:`./src/index.js`,exports:{".":{default:`./src/index.js`},"./es/*":`./es/*`,"./lib/*":`./lib/*`},files:[`es/`,`lib/`,`telemetry.yml`],types:`./src/index.d.ts`,customElements:`custom-elements.json`,scripts:{build:`node ../../../tasks/build.js`,"build:dist":`rm -rf dist && rollup --config ../../../tasks/build-dist.js`,"build:dist:canary":`rm -rf dist && rollup --config ../../../tasks/build-dist.js --configCanary`,clean:`rimraf es lib`,postinstall:`ibmtelemetry --config=telemetry.yml`,"telemetry:config":`npx -y @ibm/telemetry-js-config-generator generate --id 0a1bd1db2-dbe9-49bc-9ba9-8a7debf5b76a --endpoint https://www-api.ibm.com/ibm-telemetry/v1/metrics --files ./components/**/*.(ts|tsx|js|jsx) --wc`},dependencies:{"@babel/runtime":`^7.23.2`,"@carbon-labs/utilities":`0.28.0`,"@carbon/web-components":`^2.41.0`,"@ibm/telemetry-js":`^1.10.2`,uuid:`^14.0.0`}};function l(t){let l={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...i(),...t.components};return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(e,{of:o}),`
...
`})}),`
`,(0,s.jsx)(r,{children:`${a({components:[`empty-state`]},c)}`}),`
...
`,(0,s.jsx)(n,{of:`clabs-empty-state`})]})}function u(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,s.jsx)(t,{...e,children:(0,s.jsx)(l,{...e})}):l(e)}export{u as default};