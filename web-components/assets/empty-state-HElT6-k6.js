import{j as e,M as r,a as o,A as c}from"./blocks-Bt3acnkq.js";import{useMDXComponents as i}from"./index-KZvRYT1J.js";import{c as l}from"./storybook-cdn-BiPTSTB7.js";import{E as a}from"./empty-state.stories-mu5ZGqM0.js";import"./preload-helper-C1FmrZbK.js";import"./iframe-CXTRcuKX.js";import"./property-cu727hQW.js";import"./v4-DgssEzeg.js";import"./state-BpOGf9J4.js";import"./carbon-element-UyaF4n7V.js";import"./directive-CF8sV3Lr.js";import"./link-Cy1wingb.js";import"./focus-CVbVtspp.js";import"./query-__j_ZMY6.js";import"./button-DQCYS8mK.js";import"./host-listener-C4Ji6v3a.js";import"./button-skeleton-BMrN0tye.js";import"./spread-BGtu7H02.js";const d="@carbon-labs/wc-empty-state",m="0.9.0",p={access:"public",provenance:!0},h="Carbon Labs - empty-state component",b="Apache-2.0",u={type:"git",url:"https://github.com/carbon-design-system/carbon-labs",directory:"packages/empty-state"},x="./src/index.js",j="./src/index.js",y={".":{default:"./src/index.js"},"./es/*":"./es/*","./lib/*":"./lib/*"},g=["es/","lib/","telemetry.yml"],f="./src/index.d.ts",w="custom-elements.json",k={build:"node ../../../tasks/build.js","build:dist":"rm -rf dist && rollup --config ../../../tasks/build-dist.js","build:dist:canary":"rm -rf dist && rollup --config ../../../tasks/build-dist.js --configCanary",clean:"rimraf es lib",postinstall:"ibmtelemetry --config=telemetry.yml","telemetry:config":"npx -y @ibm/telemetry-js-config-generator generate --id 0a1bd1db2-dbe9-49bc-9ba9-8a7debf5b76a --endpoint https://www-api.ibm.com/ibm-telemetry/v1/metrics --files ./components/**/*.(ts|tsx|js|jsx) --wc"},v={"@babel/runtime":"^7.23.2","@carbon-labs/utilities":"0.14.0","@carbon/web-components":"2.36.0","@ibm/telemetry-js":"^1.10.2",uuid:"^9.0.1"},C={name:d,version:m,publishConfig:p,description:h,license:b,repository:u,main:x,module:j,exports:y,files:g,types:f,customElements:w,scripts:k,dependencies:v};function n(s){const t={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:a}),`
