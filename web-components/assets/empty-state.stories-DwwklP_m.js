import{n as i,t as Ht}from"./property-DRkoNOFH.js";import{i as nt,r as w,x as p,b as qt}from"./lit-element-CKvUdWNz.js";import{r as Vt}from"./state-BaIcuqWU.js";import{_ as c,e as g}from"./class-map-BqTUllwo.js";import{o as l}from"./if-defined-BxoUCaaX.js";import{e as Xt}from"./query-BApjzB0v.js";import{v as $}from"./v4-CQkTLCs1.js";import{e as Nt,i as Yt}from"./directive-CF8sV3Lr.js";/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const Qt=(o,s)=>{try{customElements.define(o,s)}catch{console.warn(`Attempting to re-define ${o}`)}return s},Kt=(o,s)=>{const{kind:t,elements:n}=s;return{kind:t,elements:n,finisher(r){try{customElements.define(o,r)}catch{console.warn(`Attempting to re-define ${o}`)}}}},I=o=>s=>typeof s=="function"?Qt(o,s):Kt(o,s);/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const to={MEDIUM:"md",SMALL:"sm",LARGE:"lg"};let v=class extends Ct(w){constructor(){super(...arguments),this._hasIcon=!1,this.disabled=!1,this.inline=!1,this.size=to.MEDIUM,this.visited=!1}_handleSlotChange({target:s}){const{name:t}=s,n=s.assignedNodes().some(r=>r.nodeType!==Node.TEXT_NODE||r.textContent.trim());this[t==="icon"?"_hasIcon":""]=n,this.requestUpdate()}get _classes(){const{disabled:s,size:t,inline:n,visited:r,_hasIcon:d}=this;return g({[`${e}--link`]:!0,[`${e}--link--disabled`]:s,[`${e}--link--icon`]:d,[`${e}--link--inline`]:n,[`${e}--link--${t}`]:t,[`${e}--link--visited`]:r})}_handleClick(s){}_renderInner(){const{_hasIcon:s,_handleSlotChange:t}=this;return p`
      <slot @slotchange="${t}"></slot>
      <div ?hidden="${!s}" class="${e}--link__icon">
        <slot name="icon" @slotchange="${t}"></slot>
      </div>
    `}_renderDisabledLink(){const{_classes:s}=this;return p`
      <p id="link" part="link" class="${s}">${this._renderInner()}</p>
    `}_renderLink(){const{download:s,href:t,hreflang:n,linkRole:r,ping:d,rel:f,target:u,type:h,_classes:b,_handleClick:m}=this;return p`
      <a
        tabindex="0"
        id="link"
        role="${l(r)}"
    ...
    `}render(){const{disabled:s}=this;return s?this._renderDisabledLink():this._renderLink()}};v.shadowRootOptions=Object.assign(Object.assign({},w.shadowRootOptions),{delegatesFocus:!0});v.styles=Jt;c([Xt("#link")],v.prototype,"_linkNode",void 0);c([i({type:Boolean,reflect:!0})],v.prototype,"disabled",void 0);c([i({reflect:!0})],v.prototype,"download",void 0);c([i({reflect:!0})],v.prototype,"href",void 0);c([i({reflect:!0})],v.prototype,"hreflang",void 0);c([i({type:Boolean,reflect:!0})],v.prototype,"inline",void 0);c([i({attribute:"link-role"})],v.prototype,"linkRole",void 0);c([i({reflect:!0})],v.prototype,"ping",void 0);c([i({reflect:!0})],v.prototype,"rel",void 0);c([i({reflect:!0})],v.prototype,"size",void 0);c([i({reflect:!0})],v.prototype,"target",void 0);c([i({reflect:!0})],v.prototype,"type",void 0);c([i({type:Boolean,reflect:!0})],v.prototype,"visited",void 0);v=c([I(`${e}-link`)],v);const{stablePrefix:Y}=_,oo=(o="light",s="large")=>{const t=$(),n=g({[`${Y}--empty-state__illustration`]:!0,[`${Y}--empty-state__illustration-error`]:!0,[`${Y}--empty-state__illustration--${s}`]:!0});return o==="dark"?p`
          <svg
        ...
        `},{stablePrefix:W}=_,eo=(o="light",s="large")=>{const t=$(),n=g({[`${W}--empty-state__illustration`]:!0,[`${W}--empty-state__illustration-noData`]:!0,[`${W}--empty-state__illustration--${s}`]:!0});return o==="dark"?p`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:Z}=_,so=(o="light",s="large")=>{const t=$(),n=g({[`${Z}--empty-state__illustration`]:!0,[`${Z}--empty-state__illustration-noTags`]:!0,[`${Z}--empty-state__illustration--${s}`]:!0});return o==="dark"?p`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:J}=_,no=(o="light",s="large")=>{const t=$(),n=g({[`${J}--empty-state__illustration`]:!0,[`${J}--empty-state__illustration-notFound`]:!0,[`${J}--empty-state__illustration--${s}`]:!0});return o==="dark"?p`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:Q}=_,ro=(o="light",s="large")=>{const t=$(),n=g({[`${Q}--empty-state__illustration`]:!0,[`${Q}--empty-state__illustration-notification`]:!0,[`${Q}--empty-state__illustration--${s}`]:!0});return o==="dark"?p`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
        ...
        `},{stablePrefix:K}=_,co=(o="light",s="lg")=>{const t=$(),n=g({[`${K}--empty-state__illustration`]:!0,[`${K}--empty-state__illustration-unauthorized`]:!0,[`${K}--empty-state__illustration--${s}`]:!0});return o==="dark"?p`
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const{stablePrefix:U}=_;function io(o){const{title:s,subtitle:t,size:n,kind:r,illustrationTheme:d,hasIllustration:f}=o,u=g({[`${U}--empty-state__header`]:!0,[`${U}--empty-state__header--small`]:n==="sm"}),h=g({[`${U}--empty-state___subtitle`]:!0,[`${U}--empty-state__subtitle--small`]:n==="sm"});let b;if(!f)switch(r){case"error":b=oo(d,n);break;case"noData":b=eo(d,n);break;case"noTags":b=so(d,n);break;case"notFound":b=no(d,n);break;case"notifications":b=ro(d,n);break;case"unauthorized":b=co(d,n);break}return p`
    <slot name="illustration"></slot>
    ${f?"":b}
    <div class="${U}--empty-state__content">
      <h3 class="${u}">${s}</h3>
      ${t&&p`<p class="${h}">${t}</p>`}
      <slot name="action"></slot>
      <slot name="link"></slot>
    </div>
  `}var ao=Object.defineProperty,po=Object.getOwnPropertyDescriptor,lo=(o,s,t,n)=>{for(var r=n>1?void 0:n?po(s,t):s,d=o.length-1,f;d>=0;d--)(f=o[d])&&(r=(n?f(s,t,r):f(r))||r);return n&&r&&ao(s,t,r),r};const{stablePrefix:fo}=_;let at=class extends y{firstUpdated(){var s;const o=(s=this.shadowRoot)==null?void 0:s.querySelector('slot[name="illustration"]');o==null||o.addEventListener("slotchange",()=>this.checkSlotContent()),this.checkSlotContent()}checkSlotContent(){var t;const o=(t=this.shadowRoot)==null?void 0:t.querySelector('slot[name="illustration"]'),s=(o==null?void 0:o.assignedNodes({flatten:!0}))??[];this.hasIllustration=s.length>0}render(){return io(this)}};at=lo([Ht(`${fo}-empty-state`)],at);/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const Et=(o,s,t,n)=>{const r=t._hostListeners;if(!r)throw new Error("The method `@HostListener()` is defined on has to be of a class that has `HostListerMixin`.");r[n]||(r[n]={}),r[n][o]={options:s}},vo=(o,s,t)=>{const{kind:n,key:r,placement:d}=t;if(!(n==="method"&&d==="prototype"||n==="field"&&d==="own"))throw new Error("`@HostListener()` must be defined on instance methods, but you may have defined it on static, field, etc.");return Object.assign(Object.assign({},t),{finisher(f){Et(o,s,f,r)}})},A=(o,s)=>(t,n)=>typeof n<"u"?Et(o,s,t.constructor,n):vo(o,s,t);function bo(o,...s){return o.addEventListener(...s),{release(){return o.removeEventListener(...s),null}}}/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const ho=/^((document|window|parentRoot|shadowRoot):)?([\w-]+)$/,go=o=>{class s extends o{constructor(){super(...arguments),this._handles=new Set}connectedCallback(){super.connectedCallback();const n=this.constructor._hostListeners;Object.keys(n).forEach(r=>{Object.keys(n[r]).forEach(d=>{var f;const u=ho.exec(d);if(!u)throw new Error(`Could not parse the event name: ${r}`);const[,,h,b]=u,m={document:this.ownerDocument,window:this.ownerDocument.defaultView,parentRoot:this.getRootNode(),shadowRoot:this.shadowRoot}[h]||this,{options:k}=n[r][d];this._handles.add(bo(m,(f=this.constructor[b])!==null&&f!==void 0?f:b,this[r],k))})})}disconnectedCallback(){this._handles.forEach(n=>{n.release(),this._handles.delete(n)}),super.disconnectedCallback()}}return s._hostListeners={},s};/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let a=class extends go(Ct(w)){constructor(){super(...arguments),this._hasIcon=!1,this._handleOver=()=>{this.openTooltip=!0},this._handleHoverOut=async()=>{this.openTooltip=!1},this._handleFocus=async()=>{this.openTooltip=!0},this._handleFocusout=async()=>{this.openTooltip=!1},this.autofocus=!1,this.batchAction=!1,this.disabled=!1,this.hasMainContent=!1,this.isExpressive=!1,this.isSelected=!1,this.kind=z.PRIMARY,this.linkRole="button",this.openTooltip=!1,this.size="lg",this.tooltipAlignment=ot.CENTER,this.tooltipPosition=B.TOP,this.type=tt.BUTTON}_handleSlotChange({target:s}){const{name:t}=s,n=s.assignedNodes().some(r=>r.nodeType!==Node.TEXT_NODE||r.textContent.trim());this[t==="icon"?"_hasIcon":"hasMainContent"]=n,this.requestUpdate()}_handleDisabledClick(s){const{disabled:t}=this;t&&s.stopPropagation()}render(){const{autofocus:s,buttonClassName:t,dangerDescriptor:n,disabled:r,download:d,href:f,hreflang:u,kind:h,isExpressive:b,isSelected:m,linkRole:k,openTooltip:Rt,ping:Tt,rel:Bt,size:P,target:It,tooltipAlignment:ct,tooltipPosition:q,tooltipText:F,type:V,_hasIcon:X,hasMainContent:At,_handleSlotChange:x}=this;let N={[`${e}--btn`]:!0,[`${e}--btn--${h}`]:h,[`${e}--btn--danger--tertiary`]:h===z.DANGER_TERTIARY,[`${e}--btn--danger--ghost`]:h===z.DANGER_GHOST,[`${e}--btn--disabled`]:r,[`${e}--btn--icon-only`]:X&&!At,[`${e}--btn--${P}`]:P,[`${e}--layout--size-${P}`]:P,[`${e}-ce--btn--has-icon`]:X,[`${e}--btn--expressive`]:b,[`${e}--btn--selected`]:m&&h==="ghost"};if(t){const it={};t==null||t.split(" ").forEach(jt=>{it[jt]=!0}),N=Object.assign(Object.assign({},N),it)}const D=g(N),Pt=h.includes("danger");if(f)return r?p`
          ...
          `;const Ft=ct&&(q===B.TOP||q===B.BOTTOM)?`-${ct}`:"",Dt=g({[`${e}--popover-container`]:!0,[`${e}--popover--caret`]:!0,[`${e}--popover--high-contrast`]:!0,[`${e}--tooltip`]:!0,[`${e}--icon-tooltip`]:X,[`${e}--popover--open`]:Rt,[`${e}--popover--${q}${Ft}`]:F});return F&&!r?p`
          <span class="${Dt}">
            <button
              id="button"
              part="button"
            ...
            <span class="${e}--popover">
              <span
                class="${e}--popover-content ${e}--tooltip-content">
                ${F}
              </span>
              <span class="${e}--popover-caret"></span>
            </span>
          </span>
        `:p`
          <button
            ...
            ?disabled="${r}"
            type="${l(V)}">
            ${Pt?p`<span class="${e}--visually-hidden"
                  >${n}</span
                >`:""}
            <slot @slotchange="${x}"></slot>
            <slot name="icon" @slotchange="${x}"></slot>
          </button>
        `}};a.shadowRootOptions=Object.assign(Object.assign({},w.shadowRootOptions),{delegatesFocus:!0});a.styles=H;c([A("click",{capture:!0})],a.prototype,"_handleDisabledClick",null);c([A("mouseover")],a.prototype,"_handleOver",void 0);c([A("mouseout")],a.prototype,"_handleHoverOut",void 0);c([A("focus")],a.prototype,"_handleFocus",void 0);c([A("focusout")],a.prototype,"_handleFocusout",void 0);c([i({type:Boolean,reflect:!0})],a.prototype,"autofocus",void 0);c([i({type:Boolean,reflect:!0,attribute:"batch-action"})],a.prototype,"batchAction",void 0);c([i({reflect:!0,attribute:"button-class-name"})],a.prototype,"buttonClassName",void 0);c([i({reflect:!0,attribute:"danger-descriptor"})],a.prototype,"dangerDescriptor",void 0);c([i({type:Boolean,reflect:!0})],a.prototype,"disabled",void 0);c([i({reflect:!0})],a.prototype,"download",void 0);c([i({reflect:!0,attribute:"has-main-content",type:Boolean})],a.prototype,"hasMainContent",void 0);c([i({reflect:!0})],a.prototype,"href",void 0);c([i({reflect:!0})],a.prototype,"hreflang",void 0);c([i({type:Boolean,reflect:!0})],a.prototype,"isExpressive",void 0);c([i({type:Boolean,reflect:!0})],a.prototype,"isSelected",void 0);c([i({reflect:!0})],a.prototype,"kind",void 0);c([i({attribute:"link-role"})],a.prototype,"linkRole",void 0);c([i({type:Boolean})],a.prototype,"openTooltip",void 0);c([i({reflect:!0})],a.prototype,"ping",void 0);c([i({reflect:!0})],a.prototype,"rel",void 0);c([i({reflect:!0})],a.prototype,"size",void 0);c([i({reflect:!0})],a.prototype,"target",void 0);c([i({reflect:!0,attribute:"tooltip-alignment"})],a.prototype,"tooltipAlignment",void 0);c([i({reflect:!0,attribute:"tooltip-position"})],a.prototype,"tooltipPosition",void 0);c([i({reflect:!0,attribute:"tooltip-text"})],a.prototype,"tooltipText",void 0);c([i({reflect:!0})],a.prototype,"type",void 0);a=c([I(`${e}-button`)],a);var uo=a;/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let j=class extends w{render(){return p`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.setAttribute("role","list")}};j.styles=H;j=c([I(`${e}-button-set-base`)],j);var yo=j;/**
 * @license
 *
 * Copyright IBM Corp. 2020, 2024
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let et=class extends yo{_handleSlotChange(s){s.target.assignedNodes().filter(r=>r.matches!==void 0?r.matches(this.constructor.selectorItem):!1).forEach((r,d)=>{r.setAttribute("kind",d===0?z.SECONDARY:z.PRIMARY)});const n=new CustomEvent(`${e}-btn-set-update`,{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(n)}render(){return p` <slot @slotchange="${this._handleSlotChange}"></slot> `}static get selectorItem(){return`${e}-button`}};et.styles=H;et=c([I(`${e}-button-set`)],et);/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2023
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let st=class extends uo{_handleClickLinkSkeleton(s){this.disabled&&(s.preventDefault(),s.stopPropagation())}render(){const{autofocus:s,disabled:t,download:n,href:r,hreflang:d,ping:f,rel:u,size:h,target:b,type:m}=this,k=g({[`${e}--btn`]:!0,[`${e}--skeleton`]:!0,[`${e}--btn--${h}`]:h});return r?p`
          <a
            id="button"
            role="button"
            class="${k}"
        ...
        `:p`
          <button
            ...
            ?disabled="${t}"
            type="${l(m)}"></button>
        `}};st.styles=H;st=c([I(`${e}-button-skeleton`)],st);/**
 * @license
 *
 * Copyright IBM Corp. 2019, 2024
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const zo={title:"Components/Empty State",component:"clabs-empty-state",parameters:{docs:{description:{component:"More on how to set up stories at: https://storybook.js.org/docs/web-components/writing-stories/introduction"}}}},M={title:{control:"text",description:"Empty state heading."},subtitle:{control:"text",description:"Empty state subtext."},size:{control:"radio",description:"Empty state size",options:["sm","lg"]},link:{control:"object",description:"Object for the link — this is only for Storybook and not a prop in the component."},action:{control:"object",description:"Object for the action button — this is only for Storybook and not a prop in the component"},kind:{control:"select",description:"Determines which predefined illustration will be displayed",options:["Error","No data","No tags","Not found","Notifications","Unauthorized"],mapping:{Error:"error","No data":"noData","No tags":"noTags","Not found":"notFound",Notifications:"notifications",Unauthorized:"unauthorized"}},illustrationTheme:{control:"radio",description:"Empty state illustration theme variations. To ensure you use the correct themed illustrations, you can conditionally specify light or dark based on your app's current theme value.",options:["light","dark"]},illustration:{control:"text",description:"Custom illustration — this is only for Storybook and not a prop in the component"}},Lt={href:"https://www.carbondesignsystem.com",text:"View documentation"},G=o=>{const s=g({"clabs--empty-state__illustration":!0,[`clabs--empty-state__illustration--${o.size}`]:!0});return p`
    <clabs-empty-state
      title=${o.title}
      subtitle=${o.subtitle}
      size=${o.size}
      kind=${o.kind}
      illustrationTheme=${o.illustrationTheme}>
      ${o.illustration&&p`
        <img
          slot="illustration"
          class="${s}"
      ...
      `}
      ${o.action&&p`
        <cds-button kind=${o.action.kind} size="sm" slot="action"
          >${o.action.text} ${o.action.icon}</cds-button
        >
      `}
      ${o.link&&p`
        <cds-link href=${o.link.href} slot="link">
          ${o.link.text}
        </cds-link>
      `}
    </clabs-empty-state>
  `},C={args:{title:"Example EmptyState title",subtitle:"Example subtitle",size:"lg"},argTypes:M,render:G},E={args:{title:"Example EmptyState title",subtitle:"Example subtitle",size:"lg",kind:"notFound",illustrationTheme:"light",illustration:_o},argTypes:M,render:G},O={args:{title:"Example EmptyState title",subtitle:"Example subtitle",size:"lg",action:{text:"Create new",kind:"tertiary"}},argTypes:M,render:G},L={args:{title:"Example EmptyState title",subtitle:"Example subtitle",size:"lg",action:{text:"Create new",kind:"tertiary",icon:Ot({slot:"icon"})}},argTypes:M,render:G},R={args:{title:"Example EmptyState title",subtitle:"Example subtitle",size:"lg",link:Lt},argTypes:M,render:G},T={args:{title:"Example EmptyState title",subtitle:"Example subtitle",size:"lg",link:Lt,action:{text:"Create new",kind:"tertiary",icon:Ot({slot:"icon"})}},argTypes:M,render:G};var ft,vt,bt;C.parameters={...C.parameters,docs:{...(ft=C.parameters)==null?void 0:ft.docs,source:{originalSource:`{
  args: {
...
}`,...(bt=(vt=C.parameters)==null?void 0:vt.docs)==null?void 0:bt.source}}};var ht,gt,ut;E.parameters={...E.parameters,docs:{...(ht=E.parameters)==null?void 0:ht.docs,source:{originalSource:`{
  args: {
    title: 'Example EmptyState title',
    subtitle: 'Example subtitle',
    size: 'lg',
  ...
  argTypes,
  render: renderTemplate
}`,...(ut=(gt=E.parameters)==null?void 0:gt.docs)==null?void 0:ut.source}}};var yt,mt,xt;O.parameters={...O.parameters,docs:{...(yt=O.parameters)==null?void 0:yt.docs,source:{originalSource:`{
  args: {
    title: 'Example EmptyState title',
    subtitle: 'Example subtitle',
    size: 'lg',
  ...
  argTypes,
  render: renderTemplate
}`,...(xt=(mt=O.parameters)==null?void 0:mt.docs)==null?void 0:xt.source}}};var _t,zt,kt;L.parameters={...L.parameters,docs:{...(_t=L.parameters)==null?void 0:_t.docs,source:{originalSource:`{
  args: {
    title: 'Example EmptyState title',
    subtitle: 'Example subtitle',
    size: 'lg',
  ...
  argTypes,
  render: renderTemplate
}`,...(kt=(zt=L.parameters)==null?void 0:zt.docs)==null?void 0:kt.source}}};var wt,$t,St;R.parameters={...R.parameters,docs:{...(wt=R.parameters)==null?void 0:wt.docs,source:{originalSource:`{
  args: {
    title: 'Example EmptyState title',
    subtitle: 'Example subtitle',
    size: 'lg',
  ...
  argTypes,
  render: renderTemplate
}`,...(St=($t=R.parameters)==null?void 0:$t.docs)==null?void 0:St.source}}};var Mt,Gt,Ut;T.parameters={...T.parameters,docs:{...(Mt=T.parameters)==null?void 0:Mt.docs,source:{originalSource:`{
  args: {
    title: 'Example EmptyState title',
    subtitle: 'Example subtitle',
    size: 'lg',
  ...
  argTypes,
  render: renderTemplate
}`,...(Ut=(Gt=T.parameters)==null?void 0:Gt.docs)==null?void 0:Ut.source}}};const ko=["Default","WithCustomIllustration","WithAction","WithActionIconButton","WithLink","WithActionAndLink"],Io=Object.freeze(Object.defineProperty({__proto__:null,Default:C,WithAction:O,WithActionAndLink:T,WithActionIconButton:L,WithCustomIllustration:E,WithLink:R,__namedExportsOrder:ko,default:zo},Symbol.toStringTag,{value:"Module"}));export{Io as E};
