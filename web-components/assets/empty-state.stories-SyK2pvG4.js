 ...
 */const xo={title:"Components/Empty State",component:"clabs-empty-state",parameters:{docs:{description:{component:"More on how to set up stories at: https://storybook.js.org/docs/web-components/writing-stories/introduction"}}}},b={title:{control:"text",description:"Empty state heading."},subtitle:{control:"text",description:"Empty state subtext."},size:{control:"radio",description:"Empty state size",options:["sm","lg"]},link:{control:"object",description:"Object for the link — this is only for Storybook and not a prop in the component."},action:{control:"object",description:"Object for the action button — this is only for Storybook and not a prop in the component"},kind:{control:"select",description:"Determines which predefined illustration will be displayed",options:["Error","No data","No tags","Not found","Notifications","Unauthorized"],mapping:{Error:"error","No data":"noData","No tags":"noTags","Not found":"notFound",Notifications:"notifications",Unauthorized:"unauthorized"}},illustrationTheme:{control:"radio",description:"Empty state illustration theme variations. To ensure you use the correct themed illustrations, you can conditionally specify light or dark based on your app's current theme value.",options:["light","dark"]},illustration:{control:"text",description:"Custom illustration — this is only for Storybook and not a prop in the component"}},J={href:"https://www.carbondesignsystem.com",text:"View documentation"},g=t=>{const s=n({"clabs--empty-state__illustration":!0,[`clabs--empty-state__illustration--${t.size}`]:!0});return c`
  ...
  argTypes,
  render: renderTemplate
}`,...(Y=(Z=z.parameters)==null?void 0:Z.docs)==null?void 0:Y.source}}};const zo=["Default","WithCustomIllustration","WithAction","WithActionIconButton","WithLink","WithActionAndLink"],Co=Object.freeze(Object.defineProperty({__proto__:null,Default:u,WithAction:m,WithActionAndLink:z,WithActionIconButton:_,WithCustomIllustration:h,WithLink:x,__namedExportsOrder:zo,default:xo},Symbol.toStringTag,{value:"Module"}));export{Co as E};
