import{c as e,h as t,n,s as r}from"./blocks-BAiz1bsn.js";import{n as i}from"./lib-C6Fu7zdd.js";import{n as a,t as o}from"./storybook-cdn-BXW4zS6V.js";import s from"./example-button.stories-B3a9rqQ9.js";var c=t(),l={name:`@carbon-labs/wc-example-button`,version:`0.28.0`,publishConfig:{access:`public`,provenance:!0},description:`Carbon Labs - example-button component`,labs:{status:`draft`,title:`WC Example Button`},license:`Apache-2.0`,repository:{type:`git`,url:`https://github.com/carbon-design-system/carbon-labs`,directory:`packages/example-button`},exports:{".":{default:`./src/index.js`},"./es/*":`./es/*`,"./lib/*":`./lib/*`},files:[`es/`,`lib/`],types:`./src/index.d.ts`,customElements:`custom-elements.json`,scripts:{build:`node ../../../tasks/build.js`,"build:dist":`rm -rf dist && rollup --config ../../../tasks/build-dist.js`,"build:dist:canary":`rm -rf dist && rollup --config ../../../tasks/build-dist.js --configCanary`,clean:`rimraf es lib`},dependencies:{"@babel/runtime":`^7.23.2`,"@carbon-labs/utilities":`0.28.0`,"@carbon/web-components":`^2.41.0`}};function u(t){let u={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,img:`img`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...i(),...t.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(e,{of:s}),`
