 ...
 */const{stablePrefix:i}=w;function j(s){const{content:e,_status:a,_errorMessage:l}=s;return o` <div
    ...
    ${a==="error"?o`
        ...
        `:o``}
  </div>`}var H=Object.defineProperty,k=Object.getOwnPropertyDescriptor,T=(s,e,a,l)=>{for(var t=l>1?void 0:l?k(e,a):e,r=s.length-1,c;r>=0;r--)(c=s[r])&&(t=(l?c(e,a,t):c(t))||t);return l&&t&&H(e,a,t),t};const{stablePrefix:V}=w;let b=class extends n{render(){return j(this)}};b=T([S(`${V}-chat-file-upload`)],b);/**
 * @license
 *
 * Copyright IBM Corp. 2024
 *
 ...
 */const D={title:"Components/AI Components/File Upload"},d={render:()=>o` <clabs-chat-file-upload content="Test_file.pdf">
  ...
  \`
}`,...($=(y=p.parameters)==null?void 0:y.docs)==null?void 0:$.source}}};const I=["Default","Showcase"],G=Object.freeze(Object.defineProperty({__proto__:null,Default:d,Showcase:p,__namedExportsOrder:I,default:D},Symbol.toStringTag,{value:"Module"}));export{G as e};
