import{t as k}from"./property-SleeCrad.js";import{e as w,b as N}from"./iframe-CTziTsqO.js";import{C as P}from"./CommonHeader-DGNOG10F.js";import{H as S}from"./HybridIpaasHeader-DCIDpH88.js";import"./LogoutHeader-FDdIkc8q.js";import"./LogoutTile-CiyIJfgI.js";import{s as H}from"./settings-BQP9c3yA.js";/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const I="clabs-hybrid-ipaas-header-ai-callback",j="clabs-hybrid-ipaas-header-notification-open-callback",x="clabs-hybrid-ipaas-logout-callback",B="clabs-hybrid-ipaas-search-callback",R="clabs-hybrid-ipaas-search-submit-callback";M({tagName:"clabs-global-header-hybrid-ipaas",elementClass:S,react:w,events:{onaiCallback:I,onNotificationOpenCallback:j,onLogoutCallback:x,onSearchCallback:B,onSearchSubmitCallback:R}});var D=Object.getOwnPropertyDescriptor,G=(e,l,c,p)=>{for(var o=p>1?void 0:p?D(l,c):l,b=e.length-1,s;b>=0;b--)(s=e[b])&&(o=s(o)||o);return o};const{stablePrefix:K}=H;let y=class extends O{};y=G([k(`${K}-global-header`)],y);/**
 * @license
 *
