 ...
 */const{stablePrefix:s}=f;function P(l){const{sortedParents:e,columns:o,branches:a,branchingIndices:t,debug:i}=l;return c` <div class="${s}--chat-history-viewer-container">
  ...
  </div>`}var q=Object.getOwnPropertyDescriptor,O=(l,e,o,a)=>{for(var t=a>1?void 0:a?q(e,o):e,i=l.length-1,d;i>=0;i--)(d=l[i])&&(t=d(t)||t);return t};const{stablePrefix:B}=f;let g=class extends h{render(){return P(this)}};g=O([T(`${B}-chat-history-viewer`)],g);const E=[{text:"hi",origin:"Sherlock",hasError:!1,time:"6:54",index:0,parentId:null,userSubmitted:!0,branchId:1},{text:`
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const M={title:"Components/Research/History Viewer"},b={render:()=>c` <clabs-chat-history-viewer .historyTree=${E}>
...
}`,...($=(S=p.parameters)==null?void 0:S.docs)==null?void 0:$.source}}};const N=["Default","Showcase"],G=Object.freeze(Object.defineProperty({__proto__:null,Default:b,Showcase:p,__namedExportsOrder:N,default:M},Symbol.toStringTag,{value:"Module"}));export{G as e};
