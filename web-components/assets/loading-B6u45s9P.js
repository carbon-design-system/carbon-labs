import{p as e,_ as d,e as y,c as b}from"./carbon-element-ZG_lSGav.js";import{i as m}from"./lit-element-in3Y6axH.js";import{x as i,r as h}from"./directive-Bp-AemGL.js";import{n as t}from"./property-C_111YFZ.js";/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let r=class extends h{constructor(){super(...arguments),this.assistiveText="Loading",this.type=a.REGULAR,this.overlay=!1,this.inactive=!1}render(){const{inactive:c,assistiveText:o,type:l,overlay:f}=this,g=y({[`${e}--loading`]:!0,[`${e}--loading--stop`]:c,[`${e}--loading--small`]:l===a.SMALL}),n=u({assistiveText:o,type:l});return f?i`<div class="${g}">${n}</div>`:n}};r.styles=p;d([t({attribute:"assistive-text"})],r.prototype,"assistiveText",void 0);d([t()],r.prototype,"type",void 0);d([t({type:Boolean,reflect:!0})],r.prototype,"overlay",void 0);d([t({type:Boolean,reflect:!0})],r.prototype,"inactive",void 0);r=d([b(`${e}-loading`)],r);export{a as L};
