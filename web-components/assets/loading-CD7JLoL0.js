import{p as e,_ as d,e as y,c as b}from"./carbon-element-Cjizy3rH.js";import{x as i,i as m,r as h}from"./lit-element-CKvUdWNz.js";import{n as o}from"./property-DRkoNOFH.js";/**
 * @license
 *
 ...
 */var r;(function(a){a.REGULAR="regular",a.SMALL="small"})(r||(r={}));/**
 * @license
 *
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */var u=({assistiveText:a,type:c})=>{const t=c===v.SMALL?"42":"44";return i`
    <svg class="${e}--loading__svg" viewBox="0 0 100 100">
      ${a?i` <title>${a}</title> `:void 0}
      <circle
        ?hidden="${c!==v.SMALL}"
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */let s=class extends h{constructor(){super(...arguments),this.assistiveText="Loading",this.type=r.REGULAR,this.overlay=!1,this.inactive=!1}render(){const{inactive:c,assistiveText:t,type:l,overlay:g}=this,f=y({[`${e}--loading`]:!0,[`${e}--loading--stop`]:c,[`${e}--loading--small`]:l===r.SMALL}),n=u({assistiveText:t,type:l});return g?i`<div class="${f}">${n}</div>`:n}};s.styles=p;d([o({attribute:"assistive-text"})],s.prototype,"assistiveText",void 0);d([o()],s.prototype,"type",void 0);d([o({type:Boolean,reflect:!0})],s.prototype,"overlay",void 0);d([o({type:Boolean,reflect:!0})],s.prototype,"inactive",void 0);s=d([b(`${e}-loading`)],s);
