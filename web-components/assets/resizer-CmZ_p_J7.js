import{c as e,h as t,s as n}from"./blocks-CMyaEUXS.js";import{n as r}from"./lib-CERGfbNt.js";import{n as i,t as a}from"./storybook-cdn-BXW4zS6V.js";import o from"./resizer.stories-Bg9DQb6_.js";var s=t(),c={name:`@carbon-labs/wc-resizer`,version:`0.5.0`,publishConfig:{access:`public`,provenance:!0},description:`Carbon Labs - Resizer web components for creating resizable panels`,license:`Apache-2.0`,repository:{type:`git`,url:`https://github.com/carbon-design-system/carbon-labs`,directory:`packages/web-components/src/components/resizer`},exports:{".":{default:`./src/index.js`},"./es/*":`./es/*`,"./lib/*":`./lib/*`},files:[`es/`,`lib/`],types:`./src/index.d.ts`,customElements:`custom-elements.json`,scripts:{build:`node ../../../tasks/build.js`,"build:dist":`rm -rf dist && rollup --config ../../../tasks/build-dist.js`,"build:dist:canary":`rm -rf dist && rollup --config ../../../tasks/build-dist.js --configCanary`,clean:`rimraf es lib`},dependencies:{"@babel/runtime":`^7.23.2`,"@carbon-labs/utilities":`0.21.0`,lit:`^3.2.1`}};function l(t){let l={a:`a`,blockquote:`blockquote`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,img:`img`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...r(),...t.components};return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(e,{of:o}),`
