import{I as e,R as t,U as n,X as r}from"./iframe-8oWFY5cz.js";import{t as i}from"./settings-DS_WyTy3.js";import{r as a}from"./button-DyZNqo5R.js";import"./icon-button-BGmXwjQK.js";import{t as o}from"./icon-loader-CRqwcGIF.js";import"./link-Djnnp1Ys.js";import{a as s,i as c,n as l,o as u,r as d,s as f,t as p}from"./_story.defs-8SrguH7L.js";import{t as m}from"./16-CPfFe-Vd.js";import{t as h}from"./16-BWcQl_pC.js";import{t as g}from"./search-CkSut6I8.js";var _=r(s()),{stablePrefix:v,prefix:y}=i,b={title:`Components/Style Picker/Single`,component:`clabs-style-picker`,parameters:{docs:{description:{component:`More on how to set up stories at: https://storybook.js.org/docs/web-components/writing-stories/introduction`}}}},x=n`
...
`,S=()=>{let e=document.querySelector(`${v}-style-picker`),t=document.querySelector(`#trigger`);e?.toggleAttribute(`open`),t.setAttribute(`aria-expanded`,!!e?.hasAttribute(`open`))},C=()=>{document.querySelector(`#trigger`).setAttribute(`aria-expanded`,`false`)},w=e=>{let t=e.detail.value,n=document.querySelector(`${y}-tile`);n.style.borderColor=`${t}`},T=t=>{let n=t.detail.value,r=document.getElementById(`inline-tile-icon`),i=d.find(e=>e.value===n).renderIcon,a=document.createElement(`div`);e(i,a),r.innerHTML=``,r.appendChild(a.firstElementChild)},E=t=>{let n=t.detail.value,r=c.flatMap(e=>e.items)?.find(e=>e.value===n)?.pictogram,i=document.getElementById(`inline-tile-pictogram`),a=u({...r,attrs:{...r.attrs,"aria-label":n}}),o=document.createElement(`div`);e(a,o),i.innerHTML=``,i.appendChild(o.firstElementChild)},D={open:{control:`radio`,description:`true if the modal is open`},heading:{control:`text`,description:`style picker heading.`},align:{control:`select`,options:[...p],description:`Specify how the popover should align with the trigger element`},kind:{description:"There are three different variants `'single' | 'flat' | 'disclosed'` ",control:`disabled`},enableSearch:{control:`boolean`,description:`Enable search option`},searchCloseButtonLabel:{control:`text`},emptyStateTitle:{control:`text`},emptyStateSubtitle:{control:`text`},searchInputPlaceholder:{control:`text`},searchLabel:{control:`text`}},O={args:{open:!0,heading:`Choose color`,align:f.LEFT_TOP,enableSearch:!0,searchCloseButtonLabel:`Clear search input`,emptyStateTitle:`No results found`,emptyStateSubtitle:`Try a different search`,searchLabel:`Search`},argTypes:D,render:e=>t`
      ...
      <cds-layer class="toolbar-layer">
        <clabs-style-picker
          ...
          <clabs-style-picker-section heading="Colors">
            ${l.map(e=>t`<clabs-style-picker-group heading=${e.label}>
                  ${e.items.map(e=>t`
  ...
  `},k={args:{heading:`Choose icon`,open:!0,align:f.LEFT_TOP},argTypes:D,render:e=>t`
    <style>
      ${x}
    </style>
    <div class="style-picker-story-container">
  ...
  `},A={args:{heading:`Choose pictogram`,open:!0,align:f.LEFT_TOP,enableSearch:!0,searchCloseButtonLabel:`Clear search input`,emptyStateTitle:`No results found`,emptyStateSubtitle:`Try a different search`,searchLabel:`Search`},argTypes:D,render:e=>t`
    <style>
      ${x}
    </style>
    <div class="style-picker-story-container">
            ...
            ${c.map(e=>t`<clabs-style-picker-group heading=${e.label}>
                  ${e.items.map(e=>t`
                      <clabs-style-picker-option
                        ...
                        ${u({...e.pictogram,attrs:{...e.pictogram.attrs,width:`3rem`,height:`3rem`,"aria-label":e.label}})}
                      </clabs-style-picker-option>
                    `)}
                </clabs-style-picker-group> `)}
          </clabs-style-picker-section>
      ...
      <div class="inline-tile-holder">
        <cds-tile class="inline-tile">
          <div id="inline-tile-pictogram">
            ${u({..._.default,attrs:{..._.default.attrs,"aria-label":_.default.name}})}
          </div>
          <br />
          <h6>Primary text</h6>
  ...
  \`
}`,...A.parameters?.docs?.source}}};var j=[`Color`,`Icon`,`Pictogram`];export{O as Color,k as Icon,A as Pictogram,j as __namedExportsOrder,b as default};