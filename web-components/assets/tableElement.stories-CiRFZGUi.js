import{n as e}from"./chunk-gsjJvkCQ.js";import{a as t}from"./lit-Cfdn9GWx.js";import"./tableElement-ARHUGF-s.js";var n=e({Default:()=>i,SizeTest:()=>s,__namedExportsOrder:()=>c,default:()=>r}),r={title:`Components/AI Components/Table`},i={render:()=>t` <clabs-chat-table
...
`);return i+`
`+a}var o=a(10,50),s={render:()=>t` <clabs-chat-table content="${o}" max-height="400px">
