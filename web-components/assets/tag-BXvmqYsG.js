import{j as e,M as r,a as n,A as l}from"./blocks-D6aHBM5x.js";import{useMDXComponents as o}from"./index-B4W6Q4iv.js";import{c,a}from"./storybook-cdn-BiPTSTB7.js";import{T as d}from"./tag.stories-E69ckDit.js";import"./preload-helper-C1FmrZbK.js";import"./iframe-CaJcJN16.js";import"./property-D4t-O7Ok.js";import"./definition-tooltip-BwdckSYN.js";import"./carbon-element-Des451Gc.js";import"./directive-CF8sV3Lr.js";import"./host-listener-C4Ji6v3a.js";import"./state-B5H-5Fh9.js";import"./query-BApjzB0v.js";const p="@carbon-labs/wc-ai-tag",m="0.12.0",h={access:"public",provenance:!0},b="module",g="Carbon for AI - tag component",x="Apache-2.0",j={type:"git",url:"https://github.com/carbon-design-system/carbon-labs",directory:"packages/tag"},u={".":{default:"./src/index.js"},"./es/*":"./es/*","./lib/*":"./lib/*"},f=["es/","lib/","telemetry.yml"],y="./src/index.d.ts",k="custom-elements.json",v={build:"node ../../../tasks/build.js","build:dist":"rm -rf dist && rollup --config ../../../tasks/build-dist.js","build:dist:canary":"rm -rf dist && rollup --config ../../../tasks/build-dist.js --configCanary",clean:"rimraf es lib",postinstall:"ibmtelemetry --config=telemetry.yml"},w={"@babel/core":"^7.26.0","@babel/runtime":"^7.23.2","@carbon-labs/utilities":"0.8.0","@carbon/grid":"^11.41.0","@carbon/web-components":"2.36.0","@ibm/telemetry-js":"^1.9.1"},C={name:p,version:m,publishConfig:h,type:b,description:g,license:x,repository:j,exports:u,files:f,types:y,customElements:k,scripts:v,dependencies:w};function i(s){const t={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:d}),`
...
`,e.jsx(l,{of:"clabs-tag"})]})}function R(s={}){const{wrapper:t}={...o(),...s.components};return t?e.jsx(t,{...s,children:e.jsx(i,{...s})}):i(s)}export{R as default};
