import{n as p,t as P}from"./property-CFwRwbrB.js";import{i as k,c as $,x as m}from"./iframe-C63E4b19.js";import"./definition-tooltip-CgZdO5W7.js";/**
 * @license
 *
 ...
 */const{stablePrefix:c}=v;function C(e){const{text:o,color:s,tooltipPosition:i,tooltipText:t,handleClick:r}=e;return m` <div class="${c}--tag">
  ...
  </div>`}var w=Object.getOwnPropertyDescriptor,O=(e,o,s,i)=>{for(var t=i>1?void 0:i?w(o,s):o,r=e.length-1,n;r>=0;r--)(n=e[r])&&(t=n(t)||t);return t};const{stablePrefix:S}=v;let g=class extends l{render(){return C(this)}};g=O([P(`${S}-tag`)],g);/**
 * @license
 *
 * Copyright IBM Corp. 2023
 *
...
@type {{args: {label: string}, render: (function(*): TemplateResult<1>)}}`,...(x=(h=a.parameters)==null?void 0:h.docs)==null?void 0:x.description}}};const A=["Default"],B=Object.freeze(Object.defineProperty({__proto__:null,Default:a,__namedExportsOrder:A,default:j},Symbol.toStringTag,{value:"Module"}));export{B as T};
