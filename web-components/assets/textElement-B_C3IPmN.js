 ...
 */const{stablePrefix:r}=S;function _t(c){const{_cardData:t,type:e,content:a,fileType:i,_toggleAudio:n,_isAudioPlaying:o,_audioProgress:p,_audioDuration:u,_updateAudioDuration:f,_updateAudioProgress:b,_formatAudioTime:C}=c;return s`<div class="${r}--chat-card-container">
      ...
      ${t?s` ${t.imageUrl&&e==="url"?s` <div class="${r}--chat-card-image-container">
            ...
            <div
              ...
              ${i&&e==="file"?s` <div class="${r}--chat-card-detail-side-icon">
                    ${i==="mp3"?s`${l(O())}`:i==="mp4"?s`${l(rt())}`:i==="png"?s`${l(lt())}`:i==="pdf"?s`${l(ct())}`:i==="ppt"?s`${l(dt())}`:i==="svg"?s`${l(ht())}`:i==="xls"?s`${l(pt())}`:i==="zip"?s`${l(ut())}`:i==="wmv"?s`${l(N())}`:i==="txt"?s`${l(mt())}`:i==="tsv"?s`${l(gt())}`:i==="mov"?s`${l(xt())}`:i==="jpg"?s`${l(ft())}`:i==="gif"?s`${l(vt())}`:i==="csv"?s`${l(bt())}`:s`${l(F())}`}
                  </div>`:s``}
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const{stablePrefix:Z}=S;function At(c){const{content:t}=c;return s`<div class="${Z}--chat-image-container">
    <img class="${Z}--chat-image-img" src="${t}" />
  </div>`}var Tt=Object.getOwnPropertyDescriptor,Lt=(c,t,e,a)=>{for(var i=a>1?void 0:a?Tt(t,e):t,n=c.length-1,o;n>=0;n--)(o=c[n])&&(i=o(i)||i);return i};const{stablePrefix:Pt}=S;let J=class extends H{render(){return At(this)}};J=Lt([M(`${Pt}-chat-image`)],J);/**
 * @license
 *
 * Copyright IBM Corp. 2024
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const{stablePrefix:z}=S;function Et(c){const{_carouselContent:t,_slideCounter:e,_maxSlideCounter:a,_handlePreviousSlide:i,_handleNextSlide:n,_renderedSlideCounter:o}=c;return s`<div class="${z}--chat-carousel-container">
  ...
  </div>`}var Rt=Object.getOwnPropertyDescriptor,It=(c,t,e,a)=>{for(var i=a>1?void 0:a?Rt(t,e):t,n=c.length-1,o;n>=0;n--)(o=c[n])&&(i=o(i)||i);return i};const{stablePrefix:Ut}=S;let X=class extends y{render(){return Et(this)}};X=It([M(`${Ut}-chat-carousel`)],X);/**
 * @license
 *
 * Copyright IBM Corp. 2024
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const{stablePrefix:g}=S;function Bt(c){const{_textElements:t,alignRight:e,enableHtmlRendering:a,enableSummarization:i,_updateHighlightTarget:n,_annotationURLs:o,_annotationIndex:p,_annotationList:u,_handleAnnotationClick:f,enableTextHighlighting:b,selectedAnnotationIndex:C,disableChevrons:Q,_toggleSummarization:Y,streaming:T,_showSummarization:L}=c;return s`<div
    class="${g}--chat-text"
    role="textbox"
    aria-readonly="true"
    tabindex="0"
      ...
      <div class="${g}--chat-text-content">
        ...
        ${i?s`
              <span class="${g}--chat-text-content-chevron-container">
                <span
                  class="${g}--chat-text-content-chevron ${L?g+"--chat-text-content-chevron--focused":""}"
                  @click="${Y}"
                  role="button"
                  aria-label="show all links as a carousel below">
                  ${L?s` ${l(W,{slot:"icon"})} `:s` ${l(U,{slot:"icon"})} `}
                </span>
              </span>
              <div
                class="${g}--chat-text-content-summarization-element ${L?"":g+"--chat-text-content-summarization-element-hidden"}">
                <slot name="custom-highlight-component">
                  <clabs-chat-carousel
                    selected-slide="${C}"
                    max-slides="${1}"
  ...
  </div>`}var Dt=Object.getOwnPropertyDescriptor,Ot=(c,t,e,a)=>{for(var i=a>1?void 0:a?Dt(t,e):t,n=c.length-1,o;n>=0;n--)(o=c[n])&&(i=o(i)||i);return i};const{stablePrefix:Nt}=S;let K=class extends h{render(){return Bt(this)}};K=Ot([M(`${Nt}-chat-text`)],K);export{W as _,ct as a};
