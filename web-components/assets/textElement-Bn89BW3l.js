      ...
      ${t?s` ${t.imageUrl&&e==="url"?s` <div class="${r}--chat-card-image-container">
            ...
            <div
              ...
              ${i&&e==="file"?s` <div class="${r}--chat-card-detail-side-icon">
                    ${i==="mp3"?s`${l(j())}`:i==="mp4"?s`${l(rt())}`:i==="png"?s`${l(lt())}`:i==="pdf"?s`${l(ct())}`:i==="ppt"?s`${l(dt())}`:i==="svg"?s`${l(ht())}`:i==="xls"?s`${l(pt())}`:i==="zip"?s`${l(ut())}`:i==="wmv"?s`${l(B())}`:i==="txt"?s`${l(ft())}`:i==="tsv"?s`${l(bt())}`:i==="mov"?s`${l(xt())}`:i==="jpg"?s`${l(mt())}`:i==="gif"?s`${l(gt())}`:i==="csv"?s`${l(vt())}`:s`${l(V())}`}
                  </div>`:s``}
    ...
    <div
      ...
      <div class="${b}--chat-text-content">
        ${t.map((g,C)=>s` ${g.type==="annotation"||g.type==="link"?s`
                  <span
                    class="${b}--chat-text-content-${g.type} ${R?b+"--chat-text-fade-in":""} ${v?b+"--chat-text-highlighted"+(g.active?"-active":""):""} "
                    data-index="${C}"
                  ...
                  ${X?s``:s`
                        <span
                          ...
                          <span
                            class="${b}--chat-text-content-chevron ${C===p?b+"--chat-text-content-chevron--focused":""}"
                            data-index="${C}"
                            data-source="${g.content}"
                            @click="${m}">
                            ${g.active?s`
                  ...
                  ${C===p&&!i?s`
                      ...
                      `:s``}
                `:e?s` <span
                    class="${R?b+"--chat-text-fade-in":""}">
                    ${g.text}</span
                  >`:a||g.type==="html"?s` <span
                      class="${b}--chat-text-content-${g.type}"
                      >${tt(g.text)}</span
                    >`:g.type==="new-line"?s`<br />`:g.type==="code"?s`
                        ...
                        `:g.type==="default"?s` <span
                            ...
                            >${g.text}</span
                          >`:s`<p
                            class="${b}--chat-text-content-paragraph">
                            ${g.text}
                          </p>`}`)}
        ${i?s`
              <span class="${b}--chat-text-content-chevron-container">
                <span
                  class="${b}--chat-text-content-chevron ${I?b+"--chat-text-content-chevron--focused":""}"
                  @click="${Y}"
                  role="button"
              ...
              <div
                class="${b}--chat-text-content-summarization-element ${I?"":b+"--chat-text-content-summarization-element-hidden"}">
                <slot name="custom-highlight-component">
                  <clabs-chat-carousel
                    selected-slide="${z}"
                    max-slides="${1}"
