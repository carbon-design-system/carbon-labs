 ...
 */const{stablePrefix:l}=S;function yt(o){const{_cardData:t,type:e,content:a,fileType:i,_toggleAudio:n,_isAudioPlaying:r,_audioProgress:h,_audioDuration:g,_updateAudioDuration:x,_updateAudioProgress:$,_formatAudioTime:M}=o;return s`<div class="${l}--chat-card-container">
      ...
      ${t?s` ${t.imageUrl&&e==="url"?s` <div class="${l}--chat-card-image-container">
            ...
            <div
              ...
              ${i&&e==="file"?s` <div class="${l}--chat-card-detail-side-icon">
                    ${i==="mp3"?s`${j()}`:i==="mp4"?s`${lt()}`:i==="png"?s`${ct()}`:i==="pdf"?s`${dt()}`:i==="ppt"?s`${ht()}`:i==="svg"?s`${pt()}`:i==="xls"?s`${ut()}`:i==="zip"?s`${gt()}`:i==="wmv"?s`${N()}`:i==="txt"?s`${ft()}`:i==="tsv"?s`${bt()}`:i==="mov"?s`${vt()}`:i==="jpg"?s`${xt()}`:i==="gif"?s`${mt()}`:i==="csv"?s`${$t()}`:s`${F()}`}
                  </div>`:s``}
 ...
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const{stablePrefix:G}=S;function It(o){const{content:t}=o;return s`<div class="${G}--chat-image-container">
    <img class="${G}--chat-image-img" src="${t}" />
  </div>`}var Pt=Object.defineProperty,Tt=Object.getOwnPropertyDescriptor,Lt=(o,t,e,a)=>{for(var i=a>1?void 0:a?Tt(t,e):t,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=(a?r(t,e,i):r(i))||i);return a&&i&&Pt(t,e,i),i};const{stablePrefix:Et}=S;let J=class extends H{render(){return It(this)}};J=Lt([A(`${Et}-chat-image`)],J);/**
 * @license
 *
 * Copyright IBM Corp. 2024
 *
 * This source code is licensed under the Apache-2.0 license found in the
 * LICENSE file in the root directory of this source tree.
 */const{stablePrefix:C}=S;function Ut(o){const{_carouselContent:t,_slideCounter:e,_maxSlideCounter:a,_handlePreviousSlide:i,_handleNextSlide:n,_renderedSlideCounter:r}=o;return s`<div class="${C}--chat-carousel-container">
  ...
  </div>`}var Bt=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,Ot=(o,t,e,a)=>{for(var i=a>1?void 0:a?Dt(t,e):t,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=(a?r(t,e,i):r(i))||i);return a&&i&&Bt(t,e,i),i};const{stablePrefix:jt}=S;let K=class extends _{render(){return Ut(this)}};K=Ot([A(`${jt}-chat-carousel`)],K);/**
 * @license
 *
 * Copyright IBM Corp. 2024
 *
 ...
 */const{stablePrefix:b}=S;function Nt(o){const{_textElements:t,alignRight:e,enableHtmlRendering:a,enableSummarization:i,_updateHighlightTarget:n,_annotationURLs:r,_annotationIndex:h,_annotationList:g,_handleAnnotationClick:x,enableTextHighlighting:$,selectedAnnotationIndex:M,disableChevrons:X,_toggleSummarization:tt,streaming:I,_showSummarization:P}=o;return s`<div
    ...
    <div
      ...
      <div class="${b}--chat-text-content">
        ${t.map((m,k)=>s` ${m.type==="annotation"||m.type==="link"?s`
                  <span
                    class="${b}--chat-text-content-${m.type} ${I?b+"--chat-text-fade-in":""} ${$?b+"--chat-text-highlighted"+(m.active?"-active":""):""} "
                    data-index="${k}"
        ...
        ${i?s`
              <span class="${b}--chat-text-content-chevron-container">
                <span
                  class="${b}--chat-text-content-chevron ${P?b+"--chat-text-content-chevron--focused":""}"
                  @click="${tt}"
                  role="button"
                  aria-label="show all links as a carousel below">
                  ${P?s` ${Z({slot:"icon"})} `:s` ${B({slot:"icon"})} `}
                </span>
              </span>
              <div
                class="${b}--chat-text-content-summarization-element ${P?"":b+"--chat-text-content-summarization-element-hidden"}">
                <slot name="custom-highlight-component">
                  <clabs-chat-carousel
                    selected-slide="${M}"
                    max-slides="${1}"
  ...
  </div>`}var Yt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,qt=(o,t,e,a)=>{for(var i=a>1?void 0:a?Ft(t,e):t,n=o.length-1,r;n>=0;n--)(r=o[n])&&(i=(a?r(t,e,i):r(i))||i);return a&&i&&Yt(t,e,i),i};const{stablePrefix:Wt}=S;let Q=class extends d{render(){return Nt(this)}};Q=qt([A(`${Wt}-chat-text`)],Q);export{dt as a,Z as s};
