import"./carouselElement-B5doOaYV.js";import{x as c}from"./lit-element-in3Y6axH.js";/**
 * @license
 *
...
Lincoln was born into poverty in a [log cabin](https://en.wikipedia.org/wiki/Log_cabin) in [Kentucky](https://en.wikipedia.org/wiki/Kentucky) and was raised on the [frontier](https://en.wikipedia.org/wiki/American_frontier), mainly in [Indiana](https://en.wikipedia.org/wiki/Indiana).">
  ...
  \`
}`,...(l=(r=e.parameters)==null?void 0:r.docs)==null?void 0:l.source}}};const w=["Default","Showcase"],_=Object.freeze(Object.defineProperty({__proto__:null,Default:t,Showcase:e,__namedExportsOrder:w,default:h},Symbol.toStringTag,{value:"Module"}));export{_ as T};
