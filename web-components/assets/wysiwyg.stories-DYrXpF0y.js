import{a as e}from"./lit-Cyvtm9u7.js";import"./button-FA1ku6i2.js";import{a as t,t as n}from"./story-helpers-Ca6g7ABW.js";var r={title:`Components/Wysiwyg`,tags:[`squad`,`incubating`],component:`clabs-wysiwyg`,argTypes:{toolbarSize:{control:`select`,options:[`sm`,`md`,`lg`],description:`Toolbar button size`},content:{control:`text`,description:`Initial content of the editor`}},args:{toolbarSize:`md`,content:t},decorators:[t=>e`
    ...
    `},a={render:t=>{let r=n.map(({toolbarRender:e,...t})=>t);return e`
      <clabs-wysiwyg
        .extensions=${r}
        .content=${t.content}
        @content-change=${e=>{console.log(`content-change`,e)}}
